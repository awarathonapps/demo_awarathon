...
class Ai_email_schedule extends MY_Controller {
	...
	public function DatatableRefresh() {
        $dtSearchColumns = array('am.id','am.id','am.assessment','at.description','am.start_dttm','am.end_dttm');
        ...
        $dtDisplayColumns = array('checkbox', 'id','assessment', 'start_dttm', 'end_dttm', 'status');
