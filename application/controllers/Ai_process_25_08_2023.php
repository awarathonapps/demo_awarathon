...
class Ai_process extends MY_Controller
{
    ...
    public function view_ai_process($_company_id, $_assessment_id, $_user_id)
    {
        if ($_company_id == "" or $_assessment_id == "" or $_user_id == "") {
            ...
            $partd_list = [];
            $i = 0;
            $question_result = $this->ai_process_model->get_questions($_company_id, $_assessment_id, $assessment_type, $_user_id);
    ...
    function generate_header()
    {
        $company_id = $this->mw_session['company_id'];
        $assessment_id = $this->input->post('assessment_id');
        $parameter_score_result = $this->ai_process_model->get_parameters_reports($company_id, $assessment_id);
        $params = [];
        foreach ($parameter_score_result as $psr) {
            $parameter_id = $psr->parameter_id;
            $parameter_name = $psr->parameter_name;
    ...
    public function ajax_assessmentwise_data()
    {
        ...
        $assessment_list = $this->ai_process_model->get_participants_final_report($assessment_id);
    ...
    function generate_report()
    {
        ...
        $y = 12;
        $parameter_score_result = $this->ai_process_model->get_parameters_report($company_id, $assessment_id1);
        foreach ($parameter_score_result as $psr) {
