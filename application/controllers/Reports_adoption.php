...
class Reports_adoption extends MY_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('reports_adoption_model');
    }
    ...
    public function index()
    {
        ...
        $data['report_type'] = $this->common_model->get_selected_values('assessment_report_type', 'id,description,default_selected', 'status=1');
         ...
         $data['assessment'] = $this->reports_adoption_model->get_all_assessment();
    ...
    public function assessment_wise_manager()
    {
        ...
        if ($assessment_id == '') {
            $assessment_list = $this->reports_adoption_model->assessment_wise_tariners($assessment_id, $Company_id);
        } else {
            $assessment_list = $this->reports_adoption_model->assessment_wise_manager($assessment_id);
        }
    ...
    public function assessment_started($returnflag = 0)
    {
        ...
        if ($IsCustom == '' or $IsCustom == "Last 365 Days") {
            ...
            $Day_type = "365_days";
            $AssessmentCount = $this->reports_adoption_model->assessment_started($StartStrDt, $EndDtdate, $Day_type, $Company_id);
            ...
            $report_xaxis_title = 'Yearly';
            $Day_type = 'current';
            $AssessmentCount = $this->reports_adoption_model->assessment_started($YearStartDate, $YearEndDate, $Day_type, $Company_id);
            ...
            $Day_type = "7_days";
            $AssessmentCount = $this->reports_adoption_model->assessment_started($StartStrDt, $Edate, $Day_type, $Company_id);
            $begin = new DateTime($StartStrDt);
            ...
            if ($year != '' && $month != '' && $StartWeek != '') {
                ...
                foreach ($dateByWeek as $value) {
                    ...
                    $AssessmentCount[] = $this->reports_adoption_model->assessment_index_30_60days($WStartDate, $WEndDate, $Company_id);
            ...
            if ($type <= "15") {
                ...
                $Day_type = '7_days';
                $AccuracySet = $this->reports_adoption_model->assessment_started($SDate, $EDate, $Day_type, $Company_id);
                ...
                $report_xaxis_title = 'Yearly';
                $Day_type = "365_days";
                $AssessmentCount = $this->reports_adoption_model->assessment_started($SDate, $EDate, $Day_type, $Company_id);
                $begin = new DateTime($SDate);
                $end   = new DateTime($EDate);
                for ($i = $begin; $i <= $end; $i->modify('+1 month')) {
                    $day = $i->format("m-Y");
        ...
        $Total_assessment_monthly = $this->reports_adoption_model->total_assessment_monthly($monthstartdate, $monthenddate, $lastmonthdate, $lastmonthenddate, $Company_id);
    ...
    public function get_raps_mapped_user($returnflag = 0)
    {
        ...
        if ($IsCustom == '' or $IsCustom == "Last 365 Days") {
            ...
            $report_xaxis_title = 'Yearly';
            $Day_type = "365_days";
            $UserCount = $this->reports_adoption_model->get_raps_mapped_user($StartStrDt, $EndDtdate, $Day_type, $Company_id);
            $begin = new DateTime($StartStrDt);
            $end   = new DateTime($EndDtdate);
            for ($i = $begin; $i <= $end; $i->modify('+1 month')) {
                $day = $i->format("m-Y");
            ...
            $report_xaxis_title = 'Yearly';
            $Day_type = 'current';
            $UserCount = $this->reports_adoption_model->get_raps_mapped_user($StartStrDt, $EndDate, $Day_type, $Company_id);
            for ($i = 1; $i <= $current_month; $i++) {
                $day = str_pad($i, 2, "0", STR_PAD_LEFT);
                $TempDate = Date('Y-' . $day . '-01');
            ...
            $report_xaxis_title = 'Last 7 Days';
            $Day_type = "7_days";
            $UserCount = $this->reports_adoption_model->get_raps_mapped_user($StartStrDt, $Edate, $Day_type, $Company_id);
            $begin = new DateTime($StartStrDt);
            $end   = new DateTime($Edate);
            for ($i = $begin; $i <= $end; $i->modify('+1 day')) {
                $day = $i->format("d");
            ...
            if ($year != '' && $month != '' && $StartWeek != '') {
                ...
                foreach ($dateByWeek as $value) {
                    ...
                    $EndWeek[] = date('d', strtotime($WEndDate));
                    $weeksteddate[] = $value[0] . '-' . $value[1];
                    $UserCount[] = $this->reports_adoption_model->get_rap_users_last30_60_days($WStartDate, $WEndDate, $Company_id);
                    $result = $UserCount;
                }
            } else {
                $result = '';
        ...
        // Custom Datepicker
            ...
            if ($type <= "15") {
                ...
                $Day_type = '7_days';
                $UserCount = $this->reports_adoption_model->get_raps_mapped_user($SDate, $EDate, $Day_type, $Company_id);
                $begin = new DateTime($SDate);
                $end   = new DateTime($EDate);
                for ($i = $begin; $i <= $end; $i->modify('+1 day')) {
                    $day = $i->format("d");
        ...
        $lastmonthdate = date("Y-m-d", strtotime("first day of previous month"));
        $lastmonthenddate = date('Y-m-d', strtotime('last day of previous month'));
        $rap_total_user_monthly = $this->reports_adoption_model->rap_total_user_monthly($monthstartdate, $monthenddate, $lastmonthdate, $lastmonthenddate, $Company_id);
    ...
    public function assessment_complted($returnflag = 0)
    {
        ...
        if ($IsCustom == '' or $IsCustom == "Last 365 Days") {
            ...
            $report_xaxis_title = 'Yearly';
            $Day_type = "365_days";
            $Assessment_complted = $this->reports_adoption_model->assessment_index_end($StartStrDt, $EndDtdate, $Day_type, $Company_id);
            $begin = new DateTime($StartStrDt);
            $end   = new DateTime($EndDtdate);
            for ($i = $begin; $i <= $end; $i->modify('+1 month')) {
                $day = $i->format("m-Y");
            ...
            $report_xaxis_title = 'Yearly';
            $Day_type = 'current';
            $Assessment_complted = $this->reports_adoption_model->assessment_index_end($StartStrDt, $EndDate, $Day_type, $Company_id);
            for ($i = 1; $i <= $current_month; $i++) {
                $day = str_pad($i, 2, "0", STR_PAD_LEFT);
                $TempDate = Date('Y-' . $day . '-01');
            ...
            $report_xaxis_title = 'Last 7 Days';
            $Day_type = "7_days";
            $Assessment_complted = $this->reports_adoption_model->assessment_index_end($StartStrDt, $Edate, $Day_type, $Company_id);
            $begin = new DateTime($StartStrDt);
            $end   = new DateTime($Edate);
            for ($i = $begin; $i <= $end; $i->modify('+1 day')) {
                $day = $i->format("d");
            ...
            if ($year != '' && $month != '' && $StartWeek != '') {
                ...
                foreach ($dateByWeek as $value) {
                    ...
                    $EndWeek[] = date('d', strtotime($WEndDate));
                    $weeksteddate[] = $value[0] . '-' . $value[1];
                    $Assessment_complted[] = $this->reports_adoption_model->assessment_index_end_30_60days($WStartDate, $WEndDate, $Company_id);
            ...
            $report_xaxis_title = 'Last 90 Days';
            $Day_type = "90_days";
            $AssessmentCount = $this->reports_adoption_model->assessment_index_end($StartStrDt, $EndDtdate, $Day_type, $Company_id);
            $begin = new DateTime($StartStrDt);
            $end   = new DateTime($EndDtdate);
            ...
            if ($type <= "15") {
                ...
                $report_xaxis_title = '3 to 15 Days';
                $Day_type = '7_days';
                $AccuracySet = $this->reports_adoption_model->assessment_index_end($SDate, $EDate, $Day_type, $Company_id);
                $begin = new DateTime($SDate);
                $end   = new DateTime($EDate);
                for ($i = $begin; $i <= $end; $i->modify('+1 day')) {
                    $day = $i->format("d");
                ...
                if ($startyear != '' && $startmonth != '' && $startday != '') {
                    ...
                    foreach ($dateByWeek as $value) {
                        ...
                        $EndWeek[] = date('d', strtotime($WEndDate));
                        $weeksteddate[] = $value[0] . '-' . $value[1];
                        $AssessmentCount[] = $this->reports_adoption_model->assessment_index_end_30_60days($WStartDate, $WEndDate, $Company_id);
                        $result = $AssessmentCount;
                    }
                } else {
                    $result = '';
                ...
                $report_xaxis_title = 'Yearly';
                $Day_type = "365_days";
                $AssessmentCount = $this->reports_adoption_model->assessment_index_end($SDate, $EDate, $Day_type, $Company_id);
                $begin = new DateTime($SDate);
                $end   = new DateTime($EDate);
                for ($i = $begin; $i <= $end; $i->modify('+1 month')) {
                    $day = $i->format("m-Y");
        ...
        $lastmonthdate = date("Y-m-d", strtotime("first day of previous month"));
        $lastmonthenddate = date('Y-m-d', strtotime('last day of previous month'));
        $Total_assessment_monthly = $this->reports_adoption_model->total_assessment_monthly_end($monthstartdate, $monthenddate, $lastmonthdate, $lastmonthenddate, $Company_id);
    ...
    public function total_video_uploded($returnflag = 0)
    {
        ...
        if ($IsCustom == '' or $IsCustom == "Last 365 Days") {
            ...
            $report_xaxis_title = 'Yearly';
            $Day_type = "365_days";
            $total_video_uploaded = $this->reports_adoption_model->total_video_uploaded($StartStrDt, $EndDtdate, $Day_type, $Company_id);
            $begin = new DateTime($StartStrDt);
            $end   = new DateTime($EndDtdate);
            for ($i = $begin; $i <= $end; $i->modify('+1 month')) {
                $day = $i->format("m-Y");
            ...
            $report_xaxis_title = 'Yearly';
            $Day_type = 'current';
            $total_video_uploaded = $this->reports_adoption_model->total_video_uploaded($StartStrDt, $EndDate, $Day_type, $Company_id);
            for ($i = 1; $i <= $current_month; $i++) {
                $day = str_pad($i, 2, "0", STR_PAD_LEFT);
                $TempDate = Date('Y-' . $day . '-01');
            ...
            $report_xaxis_title = 'Last 7 Days';
            $Day_type = "7_days";
            $total_video_uploaded = $this->reports_adoption_model->total_video_uploaded($StartStrDt, $Edate, $Day_type, $Company_id);
            $begin = new DateTime($StartStrDt);
            $end   = new DateTime($Edate);
            for ($i = $begin; $i <= $end; $i->modify('+1 day')) {
                $day = $i->format("d");
            ...
            if ($year != '' && $month != '' && $StartWeek != '') {
                ...
                foreach ($dateByWeek as $value) {
                    ...
                    $EndWeek[] = date('d', strtotime($WEndDate));
                    $weeksteddate[] = $value[0] . '-' . $value[1];
                    $total_video_uploaded[] = $this->reports_adoption_model->total_video_uploaded_last_30_60($WStartDate, $WEndDate, $Company_id);
            ...
            if ($type <= "15") {
                ...
                $report_xaxis_title = '3 to 15 Days';
                $Day_type = '7_days';
                $total_video_uploaded = $this->reports_adoption_model->total_video_uploaded($SDate, $EDate, $Day_type, $Company_id);
                $begin = new DateTime($SDate);
                $end   = new DateTime($EDate);
                for ($i = $begin; $i <= $end; $i->modify('+1 day')) {
                    $day = $i->format("d");
        ...
        $lastmonthdate = date("Y-m-d", strtotime("first day of previous month"));
        $lastmonthenddate = date('Y-m-d', strtotime('last day of previous month'));
        $total_video_uploaded = $this->reports_adoption_model->Month_Wise_Count($monthstartdate, $monthenddate, $lastmonthdate, $lastmonthenddate, $Company_id);
    ...
    public function total_video_processed($returnflag = 0)
    {
        ...
        if ($IsCustom == '' or $IsCustom == "Last 365 Days") {
            ...
            $report_xaxis_title = 'Yearly';
            $Day_type = "365_days";
            $total_video_processed = $this->reports_adoption_model->total_video_processed($StartStrDt, $EndDtdate, $Day_type, $Company_id);
            $begin = new DateTime($StartStrDt);
            $end   = new DateTime($EndDtdate);
            for ($i = $begin; $i <= $end; $i->modify('+1 month')) {
                $day = $i->format("m-Y");
            ...
            $report_xaxis_title = 'Yearly';
            $Day_type = 'current';
            $total_video_processed = $this->reports_adoption_model->total_video_processed($StartStrDt, $EndDate, $Day_type, $Company_id);
            for ($i = 1; $i <= $current_month; $i++) {
                $day = str_pad($i, 2, "0", STR_PAD_LEFT);
                $TempDate = Date('Y-' . $day . '-01');
            ...
            $report_xaxis_title = 'Last 7 Days';
            $Day_type = "7_days";
            $total_video_processed = $this->reports_adoption_model->total_video_processed($StartStrDt, $Edate, $Day_type, $Company_id);
            $begin = new DateTime($StartStrDt);
            $end   = new DateTime($Edate);
            for ($i = $begin; $i <= $end; $i->modify('+1 day')) {
                $day = $i->format("d");
            ...
            if ($year != '' && $month != '' && $StartWeek != '') {
                ...
                foreach ($dateByWeek as $value) {
                    ...
                    $EndWeek[] = date('d', strtotime($WEndDate));
                    $weeksteddate[] = $value[0] . '-' . $value[1];
                    $total_video_processed[] = $this->reports_adoption_model->total_video_processed_last_30_60($WStartDate, $WEndDate, $Company_id);
            ...
            if ($type <= "15") {
                ...
                $report_xaxis_title = '3 to 15 Days';
                $Day_type = '7_days';
                $total_video_processed = $this->reports_adoption_model->total_video_processed($SDate, $EDate, $Day_type, $Company_id);
                $begin = new DateTime($SDate);
                $end   = new DateTime($EDate);
                for ($i = $begin; $i <= $end; $i->modify('+1 day')) {
                    $day = $i->format("d");
        ...
        $lastmonthdate = date("Y-m-d", strtotime("first day of previous month"));
        $lastmonthenddate = date('Y-m-d', strtotime('last day of previous month'));
        $total_video_processed = $this->reports_adoption_model->Month_Wise_Count_processed($monthstartdate, $monthenddate, $lastmonthdate, $lastmonthenddate, $Company_id);
    ...
    public function total_users_Ac_In($returnflag = 0)
    {
        ...
        $report_xaxis_title = 'Yearly';
        $Day_type = 'current';
        $Total_active_inactive = $this->reports_adoption_model->total_active_inactive($StartStrDt, $EndDate, $Day_type, $Company_id);
        for ($i = 1; $i <= $current_month; $i++) {
            $day = str_pad($i, 2, "0", STR_PAD_LEFT);
            $TempDate = Date('Y-' . $day . '-01');
    ...
    public function get_raps_played_completed($returnflag = 0)
    {
        ...
        if ($IsCustom == '' or $IsCustom == "Last 365 Days") {
            ...
            $report_xaxis_title = 'Yearly';
            $Day_type = "365_days";
            $AssessmentCount = $this->reports_adoption_model->RapsPlayedComplted($StartStrDt, $EndDtdate, $Day_type, $Company_id);
            $begin = new DateTime($StartStrDt);
            $end   = new DateTime($EndDtdate);
            for ($i = $begin; $i <= $end; $i->modify('+1 month')) {
                $day = $i->format("m-Y");
            ...
            $report_xaxis_title = 'Yearly';
            $Day_type = 'current';
            $AssessmentCount = $this->reports_adoption_model->RapsPlayedComplted($YearStartDate, $YearEndDate, $Day_type, $Company_id);
            for ($i = 1; $i <= $current_month; $i++) {
                $day = str_pad($i, 2, "0", STR_PAD_LEFT);
                $TempDate = Date('Y-' . $day . '-01');
            ...
            $report_xaxis_title = 'Last 7 Days';
            $Day_type = "7_days";
            $AssessmentCount = $this->reports_adoption_model->RapsPlayedComplted($StartStrDt, $Edate, $Day_type, $Company_id);
            ...
            if ($year != '' && $month != '' && $StartWeek != '') {
                ...
                foreach ($dateByWeek as $value) {
                    ...
                    $EndWeek[] = date('d', strtotime($WEndDate));
                    $weeksteddate[] = $value[0] . '-' . $value[1];
                    $AssessmentCount[] = $this->reports_adoption_model->raps_played_completed_30_60($WStartDate, $WEndDate, $Company_id);
                    $result = $AssessmentCount;
                }
            } else {
                $result = '';
            ...
            if ($type < "15") {
                ...
                $report_xaxis_title = '3 to 15 Days';
                $Day_type = '7_days';
                $AssessmentCount = $this->reports_adoption_model->RapsPlayedComplted($SDate, $EDate, $Day_type, $Company_id);
                $begin = new DateTime($SDate);
                $end   = new DateTime($EDate);
                for ($i = $begin; $i <= $end; $i->modify('+1 day')) {
                    $day = $i->format("d");
    ...
    public function total_report_sent($returnflag = 0)
    {
        ...
        if ($IsCustom == '' or $IsCustom == "Last 365 Days") {
            ...
            $report_xaxis_title = 'Yearly';
            $Day_type = "365_days";
            $total_reports_sent = $this->reports_adoption_model->total_reports_sent($StartStrDt, $EndDtdate, $Day_type, $Company_id);
            $begin = new DateTime($StartStrDt);
            $end   = new DateTime($EndDtdate);
            for ($i = $begin; $i <= $end; $i->modify('+1 month')) {
                $day = $i->format("m-Y");
            ...
            $report_xaxis_title = 'Yearly';
            $Day_type = 'current';
            $total_reports_sent = $this->reports_adoption_model->total_reports_sent($StartStrDt, $EndDate, $Day_type, $Company_id);
            for ($i = 1; $i <= $current_month; $i++) {
                $day = str_pad($i, 2, "0", STR_PAD_LEFT);
                $TempDate = Date('Y-' . $day . '-01');
            ...
            $report_xaxis_title = 'Last 7 Days';
            $Day_type = "7_days";
            $total_reports_sent = $this->reports_adoption_model->total_reports_sent($StartStrDt, $Edate, $Day_type, $Company_id);
            $begin = new DateTime($StartStrDt);
            $end   = new DateTime($Edate);
            for ($i = $begin; $i <= $end; $i->modify('+1 day')) {
                $day = $i->format("d");
            ...
            if ($year != '' && $month != '' && $StartWeek != '') {
                ...
                foreach ($dateByWeek as $value) {
                    ...
                    $EndWeek[] = date('d', strtotime($WEndDate));
                    $weeksteddate[] = $value[0] . '-' . $value[1];
                    $total_reports_sent[] = $this->reports_adoption_model->total_reports_sent_last_30_60($WStartDate, $WEndDate, $Company_id);
            ...
            if ($type <= "15") {
                ...
                $report_xaxis_title = '3 to 15 Days';
                $Day_type = '7_days';
                $total_reports_sent = $this->reports_adoption_model->total_reports_sent($SDate, $EDate, $Day_type, $Company_id);
                $begin = new DateTime($SDate);
                $end   = new DateTime($EDate);
                for ($i = $begin; $i <= $end; $i->modify('+1 day')) {
                    $day = $i->format("d");
                ...
                $report_xaxis_title = 'Yearly';
                $Day_type = "365_days";
                $total_reports_sent = $this->reports_adoption_model->total_reports_sent_last_30_60($SDate, $EDate, $Day_type, $Company_id);
                $begin = new DateTime($SDate);
                $end   = new DateTime($EDate);
                for ($i = $begin; $i <= $end; $i->modify('+1 month')) {
                    $day = $i->format("m-Y");
        ...
        $lastmonthdate = date("Y-m-d", strtotime("first day of previous month"));
        $lastmonthenddate = date('Y-m-d', strtotime('last day of previous month'));
        $total_reports_sent = $this->reports_adoption_model->Month_Wise_Count_Send($monthstartdate, $monthenddate, $lastmonthdate, $lastmonthenddate, $Company_id);
    ...
    public function adoption_by_team_manager()
    {
        ...
        $assessment_id = $this->input->post('assessmentid', TRUE) != '' ? $this->input->post('assessmentid', TRUE) : 0;
        $Company_id =  $this->input->post('company_id', TRUE);
        $am_list = $this->reports_adoption_model->adoption_by_team_manager($assessment_id, $Company_id);
    ...
    public function adoption_by_team($returnflag = 0)
    {
        ...
        if ($Assessment_id == ''  && $TrainerIDSet == '') {
            ...
            $LAssessmentDetails = $this->reports_adoption_model->LastExpiredAssessment($CurrentDate);
            ...
            if (isset($lastAssessmentId)) {
                ...
                $FiveManager = $this->reports_adoption_model->GetFiveManager($assessment_id);
                $TrainerIDSet = array();
                if (!empty($FiveManager)) {
                    ...
                    $getUserstart = $this->reports_adoption_model->GetUserManagerwise($lastAssessmentId, $TrainerIDSet);
            ...
            $team_title = '';
            $Assessment_id = '';
            $getUserstart = $this->reports_adoption_model->GetUserManagerwise($Assessment_id, $TrainerIDSet);
            if (isset($getUserstart) && !empty($getUserstart)) {
                for ($i = 0; $i < count($TrainerIDSet); $i++) {
                    $started[] =  isset($getUserstart[$i]['started']) ? $getUserstart[$i]['started'] : '0';
                    $completed[] =  isset($getUserstart[$i]['completed']) ? $getUserstart[$i]['completed'] : '0';
            ...
            $team_title = '';
            // $getManagerName = $this->reports_adoption_model->GetManagerName($TrainerIDSet);
            $getUserstart = $this->reports_adoption_model->GetUserManagerwise($Assessment_id, $TrainerIDSet);
            if (isset($getUserstart) && !empty($getUserstart)) {
                for ($i = 0; $i < count($TrainerIDSet); $i++) {
                    $started[] =  isset($getUserstart[$i]['started']) ? $getUserstart[$i]['started'] : '0';
    ...
    public function get_adoption_divison()
    {
        ...
        $manager_set = '';
        $assessment_id = $this->input->post('assessmentid', TRUE) != '' ? $this->input->post('assessmentid', TRUE) : 0;
        $assessment_list = $this->reports_adoption_model->getdepartment($assessment_id);
        ...
        $manager_data = $this->reports_adoption_model->get_manager($assessment_id);
    ...
    public function adoption_by_divison($returnflag = 0)
    {
        ...
        if ($Assessment_id == '' && $DivisionSet == '') {
            if ($IsCustom == "") {
                ...
                $CurrentDate = date("Y-m-d");
                $LAssessmentDetails = $this->reports_adoption_model->lastassessment($startdate, $CurrentDate);
            } else {
                $LAssessmentDetails = $this->reports_adoption_model->lastassessment($SDate, $EDate);
            }
            if (isset($LAssessmentDetails)) {
                ...
                if ($ass_id != "") {
                    $Department = $this->reports_adoption_model->getdepartment($ass_id);
                } else {
                    $Department = '';
                }
                if (!empty($Department) && isset($Department)) {
                    ...
                    if ($IsCustom == "") {
                        $startdate = '';
                        $CurrentDate = date("Y-m-d");
                        $getUserstart = $this->reports_adoption_model->GetUserDepartmentwise($ass_id, $DepartmentName, $Managerset, $startdate, $CurrentDate);
                    } else if ($IsCustom == "Current Year") {
                        $startdate = date('Y-01-01');
                        $CurrentDate = date("Y-m-d");
                        $getUserstart = $this->reports_adoption_model->GetUserDepartmentwise($ass_id, $DepartmentName, $Managerset, $startdate, $CurrentDate);
                    } else {
                        $getUserstart = $this->reports_adoption_model->GetUserDepartmentwise($ass_id, $DepartmentName, $Managerset, $SDate, $EDate);
                    }
            ...
            if (isset($DivisionSet)) {
                $lastAssessmentId = '';
                $division_title = '';
                $division_name = $this->reports_adoption_model->getdepartment_name($lastAssessmentId, $DivisionSet);
                $DepartmentName = array();
                ...
                if (!empty($DepartmentName)) {
                    if ($IsCustom == '') {
                        $startdate = '';
                        $CurrentDate = date("Y-m-d");
                        $getUserstart = $this->reports_adoption_model->GetUserDepartmentwise($lastAssessmentId, $DepartmentName, $Managerset, $startdate, $CurrentDate);
                    } else if ($IsCustom == "Current Year") {
                        $startdate = date('Y-01-01');
                        $CurrentDate = date("Y-m-d");
                        $getUserstart = $this->reports_adoption_model->GetUserDepartmentwise($lastAssessmentId, $DepartmentName, $Managerset, $startdate, $CurrentDate);
                    } else {
                        $getUserstart = $this->reports_adoption_model->GetUserDepartmentwise($lastAssessmentId, $DepartmentName, $Managerset, $SDate, $EDate);
                    }
                    if (isset($getUserstart)) {
                        for ($i = 0; $i < count($getUserstart); $i++) {
                            if (isset($DepartmentName[$i])) {
            ...
            $division_title = '';
            $division_name = $this->reports_adoption_model->getdepartment_name($Assessment_id, $DivisionSet);
    ...
    public function assessment_wise_mrd()
    {
        ...
        $Company_id =  $this->input->post('company_id', TRUE);
        $assessment_list = $this->reports_adoption_model->assessment_wise_tariners($assessment_id, $Company_id);
        $region_list = $this->reports_adoption_model->get_region($assessment_id, $Company_id);
        $divsion_list = $this->reports_adoption_model->get_divsion($assessment_id, $Company_id);
    ...
    public function assessment_wise_region()
    {
        ...
        $Company_id = $this->mw_session['company_id'];
        $assessment_id = ($this->input->post('assessmentid', TRUE) ? $this->input->post('assessmentid', TRUE) : 0);
        $assessment_list = $this->reports_adoption_model->assessment_wise_region($assessment_id, $Company_id);
        if (count((array)$assessment_list) > 0) {
            foreach ($assessment_list as $value) {
                $assessment_html .= '<option value="' . $value->region_id . '">[' . $value->region_id . '] - ' . $value->region_name . '</option>';
            }
        }
        $trainer_list = $this->reports_adoption_model->assessment_wise_trainer($assessment_id, $Company_id);
    ...
    public function adoption_by_region($returnflag = 0)
    {
        ...
        if ($Assessment_id == '' and $Region_id == '') {
            if ($IsCustom == "") {
                $CurrentDate = date("Y-m-d h:i:s");
                $LAssessmentDetails = $this->reports_adoption_model->lastexpiredamt($CurrentDate, $Company_id);
            } else if ($IsCustom == "Current Year") {
                $startdate = date('Y-01-01');
                $CurrentDate = date("Y-m-d");
                $LAssessmentDetails = $this->reports_adoption_model->lastexpiredamt($startdate, $CurrentDate);
            } else {
                $LAssessmentDetails = $this->reports_adoption_model->lastassessment($SDate, $EDate);
            }
            if (count((array)$LAssessmentDetails) > 0) {
                ...
                if (!empty($last_ass_id)) {
                    $Getregion = $this->reports_adoption_model->getregion_id($last_ass_id, $Company_id);
                    if (!empty($Getregion)) {
                ...
                if (count((array)$regionid) > 0) {
                    if ($IsCustom == "") {
                        $startdate = '';
                        $CurrentDate = date("Y-m-d h:i:s");
                        $getUserstart = $this->reports_adoption_model->Adoption_by_region($last_ass_id, $Company_id, $regionid, $startdate, $CurrentDate, $Manager_id);
                    } else if ($IsCustom == "Current Year") {
                        $startdate = date('Y-01-01');
                        $CurrentDate = date("Y-m-d");
                        $getUserstart = $this->reports_adoption_model->Adoption_by_region($last_ass_id, $Company_id, $regionid, $startdate, $CurrentDate, $Manager_id);
                    } else {
                        $getUserstart = $this->reports_adoption_model->Adoption_by_region($last_ass_id, $Company_id, $regionid, $SDate, $EDate, $Manager_id);
                    }
            ...
            if ($IsCustom == "") {
                $startdate = '';
                $CurrentDate = date("Y-m-d h:i:s");
                $getuserdetails = $this->reports_adoption_model->Adoption_by_region($lastAssessmentId, $Company_id, $Region_id, $startdate, $CurrentDate, $Manager_id);
            } else if ($IsCustom == "Current Year") {
                $startdate = date('Y-01-01');
                $CurrentDate = date("Y-m-d");
                $getuserdetails = $this->reports_adoption_model->Adoption_by_region($lastAssessmentId, $Company_id, $Region_id, $startdate, $CurrentDate, $Manager_id);
            } else {
                $getuserdetails = $this->reports_adoption_model->Adoption_by_region($lastAssessmentId, $Company_id, $Region_id, $SDate, $EDate, $Manager_id);
            }
            $GetRegionName =  $this->reports_adoption_model->get_region_name($Region_id);
            ...
            if ($IsCustom == '') {
                ...
                $CurrentDate = date("Y-m-d");
                if ($Region_id != '') {
                    $getUserstart = $this->reports_adoption_model->Adoption_by_region($Assessment_id, $Company_id, $Region_id, $startdate, $CurrentDate, $Manager_id);
                } else {
                    $getUserstart = '';
                }
            } else if ($IsCustom == "Current Year") {
                ...
                if ($Region_id != '') {
                    $getUserstart = $this->reports_adoption_model->Adoption_by_region($Assessment_id, $Company_id, $Region_id, $SDate, $EDate, $Manager_id);
                } else {
                    $getUserstart = '';
                }
            }
    ...
    public function adoption_by_module_new($returnflag = 0)
    {
        ...
        if ($Assessment_id == '') {
            ...
            $EDate = date("Y-m-d");
            $LAssessmentDetails = $this->reports_adoption_model->LastExpiredFiveAssessment($SDate, $EDate, $Company_id);
            if (count((array)$LAssessmentDetails) > 0) {
                $lastAssessmentId = array();
                ...
                if (isset($lastAssessmentId) && !empty($lastAssessmentId)) {
                    ...
                    $getUserstart = $this->reports_adoption_model->getuserassessmentbased($lastAssessmentId, $Company_id);
                    if (isset($getUserstart)) {
                        for ($i = 0; $i < count((array)$getUserstart); $i++) {
                            $modules_name[] = isset($getUserstart[$i]['assessment']) ? $getUserstart[$i]['assessment'] : '0';
            ...
            $getUserstart = $this->reports_adoption_model->getuserassessmentbased($Assessment_id, $Company_id);
            if (isset($getUserstart)) {
                // $getname = $this->reports_adoption_model->getassessment_name($Assessment_id, $Company_id);
                for ($i = 0; $i < count((array)$getUserstart); $i++) {
                    $start_user_count[] =    isset($getUserstart[$i]['started']) ? $getUserstart[$i]['started'] : '0';
                    $complete_user_count[] =    isset($getUserstart[$i]['completed']) ? $getUserstart[$i]['completed'] : '0';
                    $mapped_user_count[] =    isset($getUserstart[$i]['user_mapped']) ? $getUserstart[$i]['user_mapped'] : '0';
    ...
    public function adoption_by_divison_overall($returnflag = 0)
    {
        ...
        if ($Assessment_id == '' && $DivisionSet == '') {
            if ($IsCustom == "") {
                ...
                $CurrentDate = date("Y-m-d");
                $LAssessmentDetails = $this->reports_adoption_model->lastassessment($start_date,$CurrentDate);
            } else if ($IsCustom == "Current Year") {
                $startdate = date('Y-01-01');
                $CurrentDate = date("Y-m-d");
                $LAssessmentDetails = $this->reports_adoption_model->lastassessment($startdate, $CurrentDate);
            ...
            if ($IsCustom == '') {
                $startdate = '';
                $CurrentDate = '';
                $getUserstart = $this->reports_adoption_model->GetUserDepartmentwise($Assessment_id, $DepartmentName, $Managerset, $startdate, $CurrentDate);
            } else if ($IsCustom == "Current Year") {
                $startdate = date('Y-01-01');
                $CurrentDate = date("Y-m-d");
                $getUserstart = $this->reports_adoption_model->GetUserDepartmentwise($Assessment_id, $DepartmentName, $Managerset, $startdate, $CurrentDate);
            } else {
                $getUserstart = $this->reports_adoption_model->GetUserDepartmentwise($Assessment_id, $DepartmentName, $Managerset, $SDate, $EDate);
            }
            for ($i = 0; $i < count($getUserstart); $i++) {
                // $index_dataset[] = isset($GetDivisionName[$i]['department']) ? $GetDivisionName[$i]['department'] : "Empty Data";
                $started[] = isset($getUserstart[$i]['started']) ? $getUserstart[$i]['started'] : '0';
    ...
    public function Getassessment_wise_d_r_m()
    {
        ...
        $assessment_id = ($this->input->post('assessmentid', TRUE) ? $this->input->post('assessmentid', TRUE) : 0);
        $Company_id =  $this->input->post('company_id', TRUE);
        $assessment_list = $this->reports_adoption_model->assessment_wise_managers($assessment_id, $Company_id);
        if (count((array)$assessment_list) > 0) {
            foreach ($assessment_list as $mvalue) {
                $assessment_html .= '<option value="' . $mvalue->user_id . '">[' . $mvalue->user_id . '] - ' . $mvalue->user_name . '</option>';
            }
    ...
    public function adoption_by_manager($returnflag = 0)
    {
        ...
        if ($Assessment_id == '' and $manager_id == "") {
            ...
            if ($IsCustom == "") {
                $SDate = date(("Y-m-d"),strtotime("-30 days"));
                $EDate = date("Y-m-d");
                $getfiveassessment = $this->reports_adoption_model->Last_assessment($SDate, $EDate);
            } else {
                $getfiveassessment = $this->reports_adoption_model->Last_assessment($SDate, $EDate);
            }
            ...
            if (isset($Assessment_id) && !empty($Assessment_id)) {
                ...
                $assessment_list = $this->reports_adoption_model->get_manager_details($Company_id, $Assessment_id);
                ...
                if (!empty($manager_id)) {
                    ...
                    if ($IsCustom == "") {
                        $SDate = date('Y-m-d', strtotime("-30 days"));
                        $EDate = date("Y-m-d");
                        $getmanager_score = $this->reports_adoption_model->Getscoremanagerwise($Assessment_id, $Company_id, $manager_id, $SDate, $EDate);
                    } else {
                        $getmanager_score = $this->reports_adoption_model->Getscoremanagerwise($Assessment_id, $Company_id, $manager_id, $SDate, $EDate);
                    }
    ...
    public function adoption_by_region_filters()
    {
        ...
        $assessment_html = '';
        $assessment_list = $this->reports_adoption_model->am_wise_region($assessmentid, $Company_id);
        if (count((array)$assessment_list) > 0) {
            foreach ($assessment_list as $value) {
                $assessment_html .= '<option value="' . $value->region_id . '"> [' . $value->region_id . '] - ' . $value->region_name . '</option>';
            }
        ...
        $manager = '';
        $manager_list = $this->reports_adoption_model->am_wise_managers($assessmentid);
    ...
    public function ad_by_region($returnflag = 0)
    {
        ...
        if ($Assessment_id == '' and $Region_id == '' and $Manager_id == '') {
            if ($IsCustom == "") {
                ...
                $CurrentDate = date("Y-m-d");
                $LAssessmentDetails = $this->reports_adoption_model->last_expierd_assessment($startdate, $CurrentDate);
            } else if ($IsCustom == "Current Year") {
                $startdate = date('Y-01-01');
                $CurrentDate = date("Y-m-d");
                $LAssessmentDetails = $this->reports_adoption_model->last_expierd_assessment($startdate, $CurrentDate);
            } else {
                $LAssessmentDetails = $this->reports_adoption_model->last_expierd_assessment($SDate, $EDate);
            }
            if (count((array)$LAssessmentDetails) > 0) {
                $lastAssessmentId = array();
                ...
                $regionid = array();
                if (isset($Assessment_id) &&  !empty($Assessment_id)) {
                    $Getregion = $this->reports_adoption_model->get_last_region_id($Assessment_id, $Company_id);
                    if (!empty($Getregion)) {
                    ...
                    if (count((array)$Region_id) > 0) {
                        if ($IsCustom == "") {
                            $startdate = date(("Y-m-d"),strtotime("-30 days"));
                            $CurrentDate = date("Y-m-d");
                            $getUserstart = $this->reports_adoption_model->get_region_wise_score($Assessment_id, $Company_id, $Region_id, $startdate, $CurrentDate, $Manager_id);
                        } else if ($IsCustom == "Current Year") {
                            $startdate = date('Y-01-01');
                            $CurrentDate = date("Y-m-d");
                            $getUserstart = $this->reports_adoption_model->get_region_wise_score($Assessment_id, $Company_id, $Region_id, $startdate, $CurrentDate, $Manager_id);
                        } else {
                            $getUserstart = $this->reports_adoption_model->get_region_wise_score($Assessment_id, $Company_id, $Region_id, $SDate, $EDate, $Manager_id);
                        }
                        $region_title = '';
                        if (isset($getUserstart) && !empty($getUserstart)) {
                            for ($i = 0; $i < count($regionid); $i++) {
