...
class Role_play_manager_dashboard extends MY_Controller {

    public function __construct() {
        parent::__construct();
        $acces_management = $this->check_rights('manager_dashboard');
        ...
        $this->load->model('role_play_manager_dashboard_model');
    }
    ...
    public function index() {
        ...
        $data['region_data'] = $this->role_play_manager_dashboard_model->get_trainee_region($data['company_id']);
        ...
        $data['store_data'] = $this->role_play_manager_dashboard_model->get_trainee_store($data['company_id']);
       ...
       //$assessment_list= $this->assessment_dashboard_model->get_assessment_list($company_id, $trainer_id, $start_date, $end_date);
        ...
        //----------------
        $data['assessment_data'] = $this->role_play_manager_dashboard_model->get_assessment($data['company_id'], '', $start_date, $end_date, $manager_id);
        // $data['assessment_data'] = $this->manager_dashboard_model->get_assessment($data['company_id'], '', $start_date, $end_date, $supervisor_id);
        
        $data['parameter_data'] = $this->role_play_manager_dashboard_model->get_parameter_data();
        //$data['parameter'] = $this->common_model->get_selected_values('parameter_mst', 'id,description', 'status=1', 'description');
        //Added
       //$data['participants_result']=$this->role_play_manager_dashboard_model->get_participant($company_id,$assessment_id1);     
       $participantsData = $data['participants_result']=$this->role_play_manager_dashboard_model->get_participant($company_id,$assessment_id1);     
       $data['participants_html'] = $this->load->view('role_play_manager_dashboard/candidate_list', $participantsData, true);
        $this->load->view('role_play_manager_dashboard/index', $data);
    }
    ...
    public function getdashboardData() {
       ...
       // print_r($SDate);
        ...
        if($assessment_id1!='')
        {
            ...
            //KRISHNA -- Trinity PDF Report level changes - Show trinity assessment users at Manager dashboard
            // $report_type_result = $this->common_model->get_value('assessment_mst', 'report_type', 'company_id="'.$Company_id.'" AND id="'.$assessment_id1.'"');
            $type_result = $this->common_model->get_value('assessment_mst', 'report_type, assessment_type', 'company_id="'.$Company_id.'" AND id="'.$assessment_id1.'"');
            ...
            $report_type1        = 0;
            if (isset($type_result) AND count((array)$type_result)>0){
                $report_type1 = (int)$type_result->report_type;
			...
			$_participants_result         = $this->role_play_manager_dashboard_model->get_distinct_participants($Company_id,$assessment_id1,$manager_id,$assessment_type);
			
            // $_participants_result         = $this->role_play_manager_dashboard_model->get_distinct_participants($Company_id,$assessment_id1);
            ...
            if($assessment_type == 1 || $assessment_type ==2){
                $_total_played_result     = $this->common_model->get_value('assessment_results', 'count(*) as total',"company_id = '" . $Company_id . "' AND assessment_id = '" . $assessment_id1 . "' AND trans_id > 0  AND question_id > 0 AND vimeo_uri!='' AND ftp_status=1");
            }elseif($assessment_type == 3){ //trinity
                $_total_played_result     = $this->common_model->get_value('trinity_results', 'count(*) as total',"company_id = '" . $Company_id . "' AND assessment_id = '" . $assessment_id1 . "' AND vimeo_uri!='' AND ftp_status=1");
            }
            ...
            $data['participants_html'] = $this->load->view('role_play_manager_dashboard/candidate_list', $data, true);
         }
        else
        {
            $report_type_result = $this->common_model->get_value('assessment_mst', 'report_type', 'company_id="'.$Company_id.'" AND id="'.$assessment_id1.'"');
            ...
            $data['_report_type']          = $report_type1;
            $participantsData = $data['_participants_result']=$this->role_play_manager_dashboard_model->get_participant($Company_id,$assessment_id1);     
            $data['participants_html'] = $this->load->view('role_play_manager_dashboard/candidate_list', $data, true);
        }
        //---------------
        //$participantsData = $data['participants_result']=$this->role_play_manager_dashboard_model->get_participant($Company_id,$assessment_id1);     
        
        $data['Total_Assessment'] = $this->role_play_manager_dashboard_model->get_Total_Assessment($Company_id, $SDate, $EDate, $region_id, $store_id, $supervisor_id, $report_type, $assessment_id1);
        $data['Candidate_Count'] = $this->role_play_manager_dashboard_model->get_Candidate_Assessment($Company_id, $question_type, $report_by, $SDate, $EDate, $region_id, $store_id, $report_type, $supervisor_id, $assessment_id1);
        $data['Avg_Accuracy'] = $this->role_play_manager_dashboard_model->get_Average_Accuracy($Company_id,$report_by, $SDate, $EDate, $region_id, $store_id, $report_type, $supervisor_id, $assessment_id1);
        $data['question_answer'] = $this->role_play_manager_dashboard_model->get_question_count($Company_id,$report_by, $SDate, $EDate, $region_id, $store_id, $report_type, $supervisor_id, $assessment_id1);
        $TopFiveParameter = $this->role_play_manager_dashboard_model->get_top_five_parameter($Company_id, $report_by, $SDate, $EDate, $region_id, $store_id, $report_type, $assessment_id1, $supervisor_id);
      ...
      //--- High and Low Accuracy--//
        ...
        if(count((array)$TopFiveParameter) > 0){
            ...
            $minSet = $this->role_play_manager_dashboard_model->get_bottom_five_parameter($Company_id, $report_by, $existid, $SDate, $EDate, $region_id, $store_id, $report_type, $assessment_id1, $supervisor_id);
        ...
        $BottomFiveParameter = $this->role_play_manager_dashboard_model->get_bottom_five_parameter($Company_id, $report_by, $top_five_para_id, $SDate, $EDate, $region_id, $store_id, $report_type, $assessment_id1, $supervisor_id);
        ...
        if (count((array)$session_set) > 0) {
            ...
            if($report_by==1){
              // $region_data = $this->role_play_manager_dashboard_model->overall_result_parameter(1,$passrange_from,$passrange_to,$failrange_from,$failrange_to,$SDate,$EDate,'','','',$store_id, $report_type);
                
            }else{
              // $region_data = $this->role_play_manager_dashboard_model->overall_result_assessment(1,$passrange_from,$passrange_to,$failrange_from,$failrange_to,$SDate,$EDate,'','','',$store_id, $report_type);
            }
...
//                    $data['overall_graph'] = $this->load->view('role_play_manager_dashboard/overall_graph', $Rdata, true);
                 }
            }
        } else {
            $data['overall_graph'] = "";
            ...
            $AssessmentData = $this->role_play_manager_dashboard_model->get_assessment($Company_id, '', $SDate, $EDate, $manager_id);
            // $AssessmentData = $this->manager_dashboard_model->get_assessment($Company_id, '', $SDate, $EDate, $supervisor_id);
...
//        }
        ...
        if (count((array)$session_set) > 0) {
            ...
            $failrange_to =$session_set['Fail']['range_to'];
            if($report_by==1){
                //$region_data = $this->role_play_manager_dashboard_model->overall_result_parameter(0,$passrange_from,$passrange_to,$failrange_from,$failrange_to,$StartDate,$EndDate,$region_id,$assessment_id,$step,$store_id, $report_type);
            }else{
                //$region_data = $this->role_play_manager_dashboard_model->overall_result_assessment(0,$passrange_from,$passrange_to,$failrange_from,$failrange_to,$StartDate,$EndDate,$region_id,$assessment_id,$step,$store_id, $report_type);
            }
            /*
            if (isset($region_data['region_data']) AND count((array)$region_data['region_data']) > 0) {
                $pass_color_code= $this->session->userdata('Assessment_result_session')['Pass']['range_color'];
                ...
                $pending_color_code= $this->session->userdata('Assessment_result_session')['Pending']['range_color'];
                 foreach ($region_data['region_data'] as $rkey => $regd) {
                   ...
                   $html_graph .= $this->load->view('role_play_manager_dashboard/region_graph', $Rgdata, true);
                 }
            }
            */
        }
...
//        }
       ...
       // print_r($_POST);
        ...
        if($assessment_id_array !='' && count((array)$assessment_id_array)>0){
            ...
            $assessment_id = $this->input->post('assessment_id1');
        }
        ...
        $regionset = $this->role_play_manager_dashboard_model->get_region_result($Company_id, $report_by,$region_id,$StartDate,$EndDate,$assessment_id, $report_type, $supervisor_id);
        ...
        if (count((array)$regionset) > 0) {
			if($report_by==1){
                //$Avgset = $this->role_play_manager_dashboard_model->get_region_average($Company_id, 1,$region_id,$StartDate,$EndDate,$assessment_id,$store_id);
				$Avgset = $this->role_play_manager_dashboard_model->get_region_average($Company_id, 1,$region_id,$StartDate,$EndDate,$assessment_id, $report_type, $supervisor_id);
				$Avgset2 = $this->role_play_manager_dashboard_model->get_region_average($Company_id, 3,$region_id,$StartDate,$EndDate,$assessment_id, $report_type, $supervisor_id);
			}else{
				$Avgset = $this->role_play_manager_dashboard_model->get_region_average($Company_id, 2,$region_id,$StartDate,$EndDate,$assessment_id, $report_type, $supervisor_id);
				$Avgset2 = $this->role_play_manager_dashboard_model->get_region_average($Company_id, 4,$region_id,$StartDate,$EndDate,$assessment_id, $report_type, $supervisor_id);
			}
        ...
        $data['regiontable_graph'] = $this->load->view('role_play_manager_dashboard/regiontable_view', $Rtdata, true);
        if($returnflag){
            return $data;
        }else{
            echo json_encode($data);
    ...
    public function getDatewiseRegion() {
        ...
        $RegionData = $this->role_play_manager_dashboard_model->get_trainee_region($data['company_id'], '', '', $StartDate, $EndDate);
    ...
    public function getDatewiseAssessment() {
        ...
        $data['company_id'] = $this->mw_session['company_id'];
        $assessmentchtml = '<option value="">All Assessment</option>';
        $AssessmentData = $this->role_play_manager_dashboard_model->get_assessment($data['company_id'], '', $StartDate, $EndDate, $supervisor_id);
    ...
    public function parameter_scoredata() {
        ...
        $data['assessment_result'] = $this->role_play_manager_dashboard_model->get_parameter_assessment_score_new($data['company_id'], $data['parameter_id'], $data['region_id'],$SDate,$EDate,$data['report_type'],$data['store_id'],$data['supervisor_id']);        
        $this->load->view('role_play_manager_dashboard/parameter_scoremodal', $data);
    }
    ...
    public function region_scoredata() {
        ...
        $this->load->view('role_play_manager_dashboard/regionwise_scoremodal', $data);
    }
    ...
    public function assessment_parameter_scoredata() {
        ...
        $this->load->view('role_play_manager_dashboard/assessmentparameter_scoremodal', $data);
    }
    ...
    public function regionwise_table() {
        ...
        $user_list = array();
        $regiondata_result = array();
        //$result_data = $this->role_play_manager_dashboard_model->get_parameter_user_result($company_id, $region_id, $assessment_id, $store_id);
        //$result_data = $this->role_play_manager_dashboard_model->get_parameter_user_result_new($company_id, $region_id, $assessment_id, $store_id, $report_type);
        $result_data = $this->role_play_manager_dashboard_model->get_parameter_user_result_new($company_id, $region_id, $assessment_id, $report_type);
       // print_r($result_data);
        //print_r($report_type);
        //exit;
                $Horizontal_avg =array();
        ...
        if (count((array)$result_data) > 0) {
                 // $Avgset = $this->role_play_manager_dashboard_model->get_user_average($company_id, 1,$region_id,$assessment_id,$store_id);
                $Avgset = $this->role_play_manager_dashboard_model->get_user_average($company_id, 1,$region_id,$assessment_id,$report_type);
                //$Avgset2 = $this->role_play_manager_dashboard_model->get_user_average($company_id, 3,$region_id,$assessment_id,$store_id);
                $Avgset2 = $this->role_play_manager_dashboard_model->get_user_average($company_id, 3,$region_id,$assessment_id,$report_type);
        ...
        $Rtdata['regiondata'] = $regiondata_result;
        //$Rtdata['report_type']=$report_type;
        $data['regiontable_graph'] = $this->load->view('role_play_manager_dashboard/parameter_usertable_view', $Rtdata, true);
    ...
    public function assessment_parameterwise_table() {
        ...
        $region_list = array();
        $regiondata_result = array();
        $result_data = $this->role_play_manager_dashboard_model->get_parameter_assessment_result($company_id, $assessment_id, $report_type);
        ...
        if (count((array)$result_data) > 0) {
                ...
                $Avgset = $this->role_play_manager_dashboard_model->get_pararegion_average($company_id,1,$assessment_id, $report_type);
                $Avgset2 = $this->role_play_manager_dashboard_model->get_pararegion_average($company_id,3,$assessment_id, $report_type);
        ...
        $Rtdata['para_assess'] = $para_assess;
        $Rtdata['regiondata'] = $regiondata_result;
        $data['assessmenttable_graph'] = $this->load->view('role_play_manager_dashboard/parameter_assessmenttable_view', $Rtdata, true);
    ...
    public function QuestionScoreDatatable() {
        ...
        $dtSearchColumns = array('aq.id', 'aq.question');
        ...
        if ($dtWhere <> '') {
            $dtWhere .= " AND am.company_id = " . $Company_id;
        } else {
            $dtWhere .= " WHERE am.company_id = " . $Company_id;
        }
        if ($assessment_id != "") {
        ...
        if($StartDate !='' && $EndDate !=''){
            ...
            $dtWhere .=" OR DATE(am.end_dttm) BETWEEN '".$StartDate."' AND '".$EndDate."')";  
        }
        $DTRenderArray = $this->role_play_manager_dashboard_model->get_questions_score_new($dtWhere, $dtOrder, $dtLimit, $report_type);
        $output = array(
    ...
    public function assessment_usercount() {
        ...
        $SDate = date('Y-m-d', strtotime($start_date));
        $EDate = date('Y-m-d', strtotime($end_date));
        $user_result = $this->role_play_manager_dashboard_model->get_assessment_user($assessment_id,$SDate,$EDate);
        $complete_count = 0;
        $incomplete_count = 0;
    ...
    public function region_level_scoredata(){
        ...
        if (count((array)$session_set) > 0) {
            ...
            $Result_data = $this->role_play_manager_dashboard_model->region_level_result($region_id,$StartDate,$EndDate,$pass_range_from,$pass_range_to,$fail_range_from,$fail_range_to, $report_type, $supervisor_id);
          //  print_r($Result_data);  
            ...
            $data['region_level_graph'] = $this->load->view('role_play_manager_dashboard/region_level_graph', $Rdata, true);
        }else{
       ...
       $Company_id = $this->mw_session['company_id'];
        ...
        if ($rpt_period == "weekly") {
            if ($WeekStartDate != '' && $WeekEndDate != '') {
                ...
                $supervisor_id = $this->input->post('supervisor_id', true);
                $AccuracySet = $this->role_play_manager_dashboard_model->assessment_index_weekly_monthly($report_by,$WeekStartDate, $WeekEndDate, $report_type, $supervisor_id ,'', $assessment_id1);
            ...
            $AccuracySet = $this->role_play_manager_dashboard_model->assessment_index_yearly($report_by,$WeekStartDate, $WeekEndDate, $report_type, $supervisor_id, $assessment_id1);
          //  print_r($AccuracySet);
           // exit;
            for ($i = 1; $i <= 12; $i++) {
                $day = str_pad($i, 2, "0", STR_PAD_LEFT);
	...
	public function load_parameter_index($returnflag=0) {
       ...
       $Company_id = $this->mw_session['company_id'];
        ...
        if ($rpt_period == "weekly") {
            if ($WeekStartDate != '' && $WeekEndDate != '') {
                $AccuracySet = $this->role_play_manager_dashboard_model->parameter_index_charts($parameter_id, $report_by,$report_type,$WeekStartDate, $WeekEndDate,'',$supervisor_id, $assessment_id1);
                for ($i = $WeekStartDay; $i <= $WeekEndDay; $i++) {
                    $day = str_pad($i, 2, "0", STR_PAD_LEFT);
                    if ($Year != '' && $Month != '') {
                        $TempDate = $Year . '-' . $Month . '-' . $i;
        ...
        if($parameter_id !=''){
            $parameter_data = $this->role_play_manager_dashboard_model->get_parameter_data($parameter_id);
            // $parameter_data = $this->common_model->get_value('parameter_mst', 'id,description', 'status=1 and id='.$parameter_id);
            $report_paratitle = ' <strong>'.$parameter_data[0]->parameter.'</strong>';
        }else{
        ...
        $indexAssessGraph = $this->load->view('role_play_manager_dashboard/parameter_index_report', $PRdata, true);
    ...
    public function ajax_assessmentwise_data() {
        ...
        $assessment_list= $this->role_play_manager_dashboard_model->get_assessment($company_id,'', $start_date, $end_date, $userid_id);
    ...
    public function fetch_questions(){
        ...
        $_participants_result         = $this->role_play_manager_dashboard_model->get_questions($company_id,$assessment_id,$user_id);
        $data['_participants_result'] = $_participants_result;
        $html1                         = $this->load->view('role_play_manager_dashboard/load_questions',$data,true);
        $data['html_1']                 = $html1;
        $data['success']              = "true";
        $data['message']              = "";
        echo json_encode($data);
