...
class Workshops_reports extends MY_Controller
{
    ...
    {
        parent::__construct();
        $acces_management = $this->check_rights('knowledge_assessment_reports');
        ...
        $this->acces_management_traineeplayed = $this->check_rights('assessment_reports_traineeplayed');
        $this->acces_management_traineesummary = $this->check_rights('assessment_reports_traineesummary');
        $this->acces_management_traineetopic = $this->check_rights('assessment_reports_traineetopic');
        $this->acces_management_trainersummary = $this->check_rights('assessment_reports_trainersummary');
        $this->acces_management_consolidate = $this->check_rights('assessment_reports_consolidate');
        $this->acces_management_workshop = $this->check_rights('assessment_reports_workshop');
        $this->acces_management_question = $this->check_rights('assessment_reports_question');
        $this->acces_management_device_emi = $this->check_rights('assessment_reports_device_emi');
    }
    ...
    public function index()
    {
        ...
        $data['acces_management_traineeplayed'] = $this->acces_management_traineeplayed;
        $data['acces_management_traineesummary'] = $this->acces_management_traineesummary;
        $data['acces_management_traineetopic'] = $this->acces_management_traineetopic;
        $data['acces_management_trainersummary'] = $this->acces_management_trainersummary;
        $data['acces_management_consolidate'] = $this->acces_management_consolidate;
        $data['acces_management_workshop'] = $this->acces_management_workshop;
        $data['acces_management_question'] = $this->acces_management_question;
        $data['acces_management_device_emi'] = $this->acces_management_device_emi;
