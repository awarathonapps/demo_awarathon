...
class Role_play_manager_dashboard_model extends CI_Model
{
    ...
    public function get_Total_Assessment($Company_id, $start_date = '', $end_date = '', $region_id = '', $store_id = '', $supervisor_id, $report_type, $assessment_id = '')
    {
        $cond = "";
    ...
    public function get_Candidate_Assessment($Company_id, $question_type, $report_by, $start_date = '', $end_date = '', $region_id = '', $store_id = '', $report_type, $supervisor_id, $assessment_id = '')
    {
        ...
        if ($report_type == "2") {
            $query = "SELECT count(distinct ar.user_id) as assessment_candidate 
                FROM assessment_trainer_weights ar
    ...
    public function get_region_result($Company_id, $report_by, $region_id = '', $SDate = '', $EDate = '', $assessment_id = '', $report_type, $supervisor_id)
    {
        ...
        if ($report_type == "2") {
            ...
            $query1 .= " WHERE du.user_id IS NOT NULL ";
            $query1 .= $cond;
