...
<!-- <style>
    ...
    <div id='container'>
        <div id='AdoptionByDivision' style='min-width: 100%; height: 300px; background:white;text-align:center'>
...
<div id='container'>
    <div id='AdoptionByDivision' style='min-width: 100%; height: 300px;'></div>
    <div class="clearfix"></div>
</div>
<?php
$report_title;
...
<script>
    ...
    $(document).ready(function() {
        ...
        Highcharts.chart('AdoptionByDivision', {
            chart: {
                type: 'bar',
                marginTop: 50,
                spacingBottom: 25,
                events: {
                    load: function() {
                        this.renderer.image('<?= base_url(); ?>assets/images/poweredby-awarathon-logo.png',this.chartWidth/2 - 24, this.chartHeight - 10, 80, 10).add();
                    }
                }
            },
            title: {
            ...
            exporting: {
                ...
                filename: 'Adoption by Division ' + <?php echo $report_title ?> + '',
                buttons: {
                    contextButton: {
                        symbol: 'download',
                        symbolStroke: "#004369",
