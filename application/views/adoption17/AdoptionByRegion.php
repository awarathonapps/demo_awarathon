...
<!-- <style>
    ...
    <div id='container'>
        <div id='AdoptionByRegion' style='min-width: 100%; height: 300px; background:white;text-align:center'>
...
<?php }  else{ ?>
<div id='container'>
    <div id='AdoptionByRegion' style='min-width: 100%; height: 300px;'></div>
    <div class="clearfix"></div>
</div>
