                ...
                <?php foreach ($best_video_list as $bvl) { ?>
                    <tr nobr="true">
                        <?php if ($reference_video_right || $best_video_right) { ?>
                            ...
                            <?php if ($reference_video_right) { ?>
                                <td
                                    style="background-color:#e4e4e4;width:<?= $width ?>;height:30px;font-size:13px;font-weight:normal;line-height:24px;text-align:center;">
            ...
            <table border="1" style="width:100%">
                <tr>
                    <td
                        ...
                        S No.</td>
                    <td
                        style="width:68%;background-color:#004369;color:#ffffff;height:30px;font-size:15px;font-weight:bold;line-height:24px;text-align:center;">
                        Question Wise report for participant</td>
                    <td
                        style="width:22%;background-color:#004369;color:#ffffff;height:30px;font-size:15px;font-weight:bold;line-height:24px;text-align:center;">
                        Your Score</td>
                ...
                <?php foreach ($questions_list as $que) { ?>
                    <tr nobr="true">
                        ...
                        <td style="width:68%;height:30px;font-size:13px;line-height:24px;text-align:left;">
                            <?php echo $que['question']; ?>
                        </td>
                        <td
                            style="background-color:#e4e4e4;width:22%;height:30px;font-size:13px;line-height:24px;text-align:center;">
            ...
            <table border="1" style="width:100%">
                <tr>
                    <td
                        ...
                        Parameter</td>
                    <td
                        style="width:40%;background-color:#004369;color:#ffffff;height:30px;font-size:15px;font-weight:bold;line-height:24px;text-align:center;">
                        Your Score</td>

                </tr>
                <?php foreach ($parameter_score as $ps) { ?>
                    <tr>
                        <td style="width:60%;height:30px;font-size:13px;line-height:24px;text-align:center;">
                            <?php echo ($ps['parameter_label_name'] != '') ? $ps['parameter_label_name'] : $ps['parameter_name']; ?>
                        </td>
                        <td
                            style="background-color:#e4e4e4;width:40%;height:30px;font-size:13px;line-height:24px;text-align:center;">
            ...
            <table border="1" style="width:100%">
                <tr>
                    <td
                        ...
                        S No.</td>
                    <td
                        style="width:90%;background-color:#004369;color:#ffffff;height:30px;font-size:15px;font-weight:bold;line-height:24px;text-align:center;">
                        Manager Comments</td>
                </tr>
                <?php foreach ($manager_comments_list as $mst) { ?>
                    <tr nobr="true">
                        <td style="width:10%;height:30px;font-size:13px;line-height:24px;text-align:center;">
                            <?php echo $mst['question_series']; ?>
                        </td>
                        <td style="width:90%;height:30px;font-size:13px;line-height:24px;text-align:center;">
                            <?php echo $mst['comments']; ?>
                        </td>
                    </tr>
                <?php } ?>
            </table>
    ...
    <tr>
        <td>
            <table border="1" style="width:100%">
                <tr>
                    <td
                        style="width:100%;height:30px;font-size:18px;font-weight:bold;line-height:30px;text-align:center;">
                        Overall Comments</td>
                </tr>
                <tr>
                    <td style="width:100%;height:100px;font-size:13px;line-height:16px;">
                        <?php echo $overall_comments; ?>
                    </td>
                </tr>
            </table>
        </td>
