    ...
    <tr>
        ...
        <table border="1" style="width:100%">
            ...
            <tr>
                ...
                <td style="height:30px;font-size:15px;text-align:center;"><?php echo isset($attempt) ? $attempt : ''; ?></td>
            </tr>
        </table>
        </td>
        <td style="width:15%">&nbsp;</td>
...
<table style="width:100%">
    <tr>
        ...
        <div class="video-title"><p >Part A: Reference <?= $label ?> vs. Your <?= $label ?></p></div>
        </td>
    </tr>
    <tr>
        <td>
            <table border="1" style="width:100%">
                ...
                <tr>
                    ...
                    <td style="width:45%;background-color:#004369;color:#ffffff;height:30px;font-size:15px;font-weight:bold;line-height:24px;text-align:center;">Reference <?= $label ?></td>
                    <td style="width:45%;background-color:#004369;color:#ffffff;height:30px;font-size:15px;font-weight:bold;line-height:24px;text-align:center;">Your <?= $label ?></td>
                </tr>
            ...
            <?php }else{ ?>
                <tr>
                    ...
                    <td style="width:80%;background-color:#004369;color:#ffffff;height:30px;font-size:15px;font-weight:bold;line-height:24px;text-align:center;">Your <?= $label ?></td>
                </tr>
                <?php foreach($best_video_list as $bvl){ ?>
                <tr>
...
<table style="width:100%">
    ...
    <tr>
        ...
        <?php if ($show_ranking==1 OR $show_ranking=="1") {?>
            <tr>
                <td style="width:10%;background-color:#004369;color:#ffffff;height:30px;font-size:15px;font-weight:bold;line-height:24px;text-align:center;">S No.</td>
                <td style="width:53%;background-color:#004369;color:#ffffff;height:30px;font-size:15px;font-weight:bold;line-height:24px;text-align:center;">Question Wise report for participant</td>
                <td style="width:17%;background-color:#004369;color:#ffffff;height:30px;font-size:15px;font-weight:bold;line-height:24px;text-align:center;">Your Score</td>
            ...
            <tr nobr="true">
                ...
                <td style="width:53%;height:30px;font-size:13px;line-height:24px;text-align:left;"><?php echo $que['question'];?></td>
                <td style="background-color:#e4e4e4;width:17%;height:30px;font-size:13px;line-height:24px;text-align:center;"><?php echo ($que['your_score']<=0 AND $que['failed_counter_your']==3)?"Jarvis Unable To Process":number_format($que['your_score'],2,'.','').'%';?></td>
                <td style="background-color:#e4e4e4;width:20%;height:30px;font-size:13px;line-height:24px;text-align:center;"><?php echo ($que['highest_score']<=0 AND $que['failed_counter_max']==3)?"Jarvis Unable To Process":number_format($que['highest_score'],2,'.','').'%';?></td>
            ...
            <?php foreach($questions_list as $que){ ?>
            <tr nobr="true">
                <td style="width:20%;height:30px;font-size:13px;line-height:24px;text-align:center;"><?php echo $que['question_series'];?></td>
                <td style="width:60%;height:30px;font-size:13px;line-height:24px;text-align:left;"><?php echo $que['question'];?></td>
                <td style="background-color:#e4e4e4;width:20%;height:30px;font-size:13px;line-height:24px;text-align:center;"><?php echo number_format($que['your_score'],2,'.','').'%';?></td>
            </tr>
            <?php } ?>
        <?php } ?>
            </table>
    ...
    <tr>
        ...
        <?php if ($show_ranking==1 OR $show_ranking=="1") {?>
            <tr>
                ...
                <td style="width:25%;background-color:#004369;color:#ffffff;height:30px;font-size:15px;font-weight:bold;line-height:24px;text-align:center;">Your Score</td>
                <td style="width:25%;background-color:#004369;color:#ffffff;height:30px;font-size:15px;font-weight:bold;line-height:24px;text-align:center;">Highest Score</td>
            ...
            <tr>
                <td style="width:50%;height:30px;font-size:13px;line-height:24px;text-align:center;"><?php echo ($ps['parameter_label_name']!='')?$ps['parameter_label_name']:$ps['parameter_name'];?></td>
                <td style="background-color:#e4e4e4;width:25%;height:30px;font-size:13px;line-height:24px;text-align:center;"><?php echo number_format($ps['your_score'],2,'.','').'%';?></td>
                <td style="background-color:#e4e4e4;width:25%;height:30px;font-size:13px;line-height:24px;text-align:center;"><?php echo number_format($ps['highest_score'],2,'.','').'%';?></td>
        ...
        <?php }else{ ?>
            ...
            <?php foreach($parameter_score as $ps){ ?>
            <tr>
                <td style="width:70%;height:30px;font-size:13px;line-height:24px;text-align:center;"><?php echo ($ps['parameter_label_name']!='')?$ps['parameter_label_name']:$ps['parameter_name'];?></td>
                <td style="background-color:#e4e4e4;width:30%;height:30px;font-size:13px;line-height:24px;text-align:center;"><?php echo number_format($ps['your_score'],2,'.','').'%';?></td>
            </tr>
            <?php } ?>
        <?php } ?>
        </table>
    ...
    <tr>
        ...
        <table border="1" style="width:100%">
            ...
            <tr>
                ...
                <td style="width:50%;height:30px;font-size:13px;line-height:16px;">Body language is one of the most important parameters, to win the confidence of the customer. AI Model trained for recognizing relevant parameters (facial expression and tone) for mapping body language.
                </td>
            </tr>
            <tr>
