                    ...
                    <table class="table table-bordered" id="aiprocess_tb">
                        <thead>
                            <tr>
                                ...
                                <?php if($isAdmin){ ?> 
                                    <th style="width:5%">Excel <br/>Dump</th> 
                                <?php if($assessment_type == 2){ ?>
                                    <th style="width:5%">Spotlight <br />Dump</th>
                                <?php } ?>
                                <?php } ?>
                        ...
                        <tbody>
                            <?php 
                                if(count((array)$_participants_result)>0){
                                    foreach ($_participants_result as $pdata) { 
                                        ...
                                        $process_dt      = $pdata->process_dt;
                                        $datediff        = $pdata->datediff;
                                        $time_diff        = $pdata->time_diff;
                            ...
                            ?>
                                        <tr>
                                            ...
                                            <?php if ($isAdmin && $assessment_type == 2) { ?>
                                            <td>
