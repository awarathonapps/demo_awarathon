                            ...
                            <div class="col-md-12">
                                ...
                                <div class="portlet light bordered">
                                    ...
                                    <div class="col-md-3">    
                                        <div class="form-group">
                                            <label>View As</label>
                                            <select id="view_type" name="view_type" class="form-control input-sm " placeholder="Please select" onchange="DatatableRefresh()">                                                                
												<option value="0">Assessor</option>
                                                <option value="1" <?php echo ($role_id==1 || $role_id==2 || $role_id==4) ?'selected':'';?>>Supervisor</option>
                                            </select>
                                        </div>
                                    </div>
                                    <!--< ?php } ?> -->
                    ...
                    buttons: {
                        ...
                        action: function(){
                            $.ajax({
                                ...
                                url: "<?php echo base_url(); ?>assessment/record_actions/"+opt,
                ...
                $.confirm({
                    ...
                    buttons: {
                        ...
                        action: function(){
                            $.ajax({
                                type: "POST",
                                url: "<?php echo base_url();?>assessment/remove/"+Id,
                                success: function (response_json) {
                                    var response= JSON.parse(response_json);
                                    ShowAlret(response.message,response.alert_type);
                                    DatatableRefresh();
...
//                }
                ...
                table.dataTable({
                    ...
                    "processing": true,
                    "serverSide": true,
                    "sAjaxSource": "<?php echo base_url() . 'assessment/DatatableRefresh'; ?>",
