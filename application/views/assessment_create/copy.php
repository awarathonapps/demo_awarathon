                                                                                ...
                                                                                foreach ($assessment_trans as $ky => $tr_id) {
                                                                                    ...
                                                                                    ?>
                                                                                        ...
                                                                                        //} ?>
                                                                                            ...
                                                                                            <td>
                                                                                                <a class="btn btn-success btn-sm" href="<?php echo base_url() . 'assessment_create/add_parameters/' . $key . '/' . $result->assessment_type . '/' . $result->company_id; ?>" 
                                                                                                accesskey="" <?php echo 'data-target="#LoadModalFilter" data-toggle="modal"' ?>>Manage Parameters </a>
                                                                                        
                                                                                                <a class="btn btn-success btn-sm" id="btnaddpanel3"  href="<?php echo base_url() . 'assessment_create/edit_questions/' . $key; ?>" 
                                                                                                <?php echo 'data-target="#LoadModalFilter" data-toggle="modal"' ?>><i class="fa fa-pencil"></i> </a>                                                                    
