                ...
                <div class="page-content-wrapper">
                    <div class="page-content">
                        ...
                        <form id="FilterFrm" name="FilterFrm" method="post">
                            ...
                            <!-- PAGE BAR -->      
                            <h1 class="page-title">
                             Go Live Trainee Dashboard <small>reports &amp; statistics</small>
                            </h1>
                                                    ...
                                                    <div class="row margin-bottom-10">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-9" style="padding:0px;">
                                                                     <select id="user_id" name="user_id" class="form-control input-sm select2_rpt" placeholder="Please select"  style="width: 100%" >
                                                ...
                                                <div class="col-lg-4 col-md-3 col-sm-6 col-xs-12" style="padding: 0px 5px 5px 5px;">
                                                    <div class="dashboard-stat">
                                                        <div class="display">
                                                            <div class="number">
                                                                <h3 class="font-orange-sharp">
                                                                    <span data-counter="counterup" id="total_time" data-value="--">--</span>
                                                                </h3>
...
<!--        <script src="< ?php echo $asset_url;?>assets/global/highcharts/highcharts.js"></script>-->
        ...
        <script src="<?php echo $asset_url; ?>assets/customjs/assessment_trainee_dashboard.js"></script>
        <script>
