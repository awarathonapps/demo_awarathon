                            ...
                            <div class="col-md-12">
                                ...
                                <div class="portlet light bordered">
                                    ...
                                    <div class="portlet-body">
                                        <form id="frmRole" name="frmRole" method="POST" action="<?php echo $base_url; ?>company_roles/update/<?php echo base64_encode($role_data->arid); ?>">    
                                            <?php if($Company_id=="") { ?>
                                            <div class="row">
                                                <div class="col-md-3">    
                                                    <div class="form-group">
                                                        <label>Company Name<span class="required"> * </span></label>
                                                        <select id="company_id" name="company_id" class="form-control input-sm select2" placeholder="Please select" <?php echo ($DisabledFlag ? 'disabled':''); ?> >
