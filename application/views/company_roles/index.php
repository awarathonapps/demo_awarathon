                    ...
                    <div class="page-content">
                        ...
                        <div class="page-bar">
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <span>Roles</span>
                                    <a data-title="An company role comprises a set of privileges that determine what users can see and do after signing in">
                            ...
                            <div class="page-toolbar">
                                <a href="<?php echo $base_url ?>company_roles/create" class="btn btn-sm btn-orange pull-right">Create New</a>&nbsp;
                            </div>
                            <?php } ?>
                        </div>
                        <div class="row mt-10">
                                                                                ...
                                                                                confirm: {
                                                                                    ...
                                                                                    action: function () {
                                                                                        $.ajax({
                                                                                            ...
                                                                                            url: "<?php echo $base_url; ?>company_roles/record_actions/" + opt,
                                                                                            beforeSend: function () {
                                                                                                customBlockUI();
                                                                                            },
                                                                            ...
                                                                            buttons: {
                                                                                confirm: {
                                                                                    ...
                                                                                    action: function () {
                                                                                        $.ajax({
                                                                                            type: "POST",
                                                                                            url: "<?php echo $base_url; ?>company_roles/remove",
                                                                                            data: {deleteid: Id},
                                                                                            beforeSend: function () {
                                                                                                customBlockUI();
                                                                                            },
...
//                }
                                                                        ...
                                                                        table.dataTable({
                                                                            ...
                                                                            "columnDefs": [
                                                                                ...
                                                                                {'width': '90px', 'orderable': false, 'searchable': true, 'targets': [3]},
                                                                            ...
                                                                            "processing": true,
                                                                            "serverSide": true,
                                                                            "sAjaxSource": "<?php echo base_url() . 'company_roles/DatatableRefresh'; ?>",
