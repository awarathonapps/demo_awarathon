        ...
        <script>
            jQuery(document).ready(function() {
                ...
                $("#country_id").select2("trigger", "select", { 
                    data: { id: "<?php echo $result->country; ?>",text:"<?php echo $result->country_name; ?>" } 
                });
                $('#state_id').select2({
                    placeholder: '',
                ...
                $("#state_id").select2("trigger", "select", { 
                    data: { id: "<?php echo $result->state; ?>",text:"<?php echo $result->state_name; ?>" } 
                });
                $('#city_id').select2({
                    placeholder: '',
                ...
                $("#city_id").select2("trigger", "select", { 
                    data: { id: "<?php echo $result->city; ?>",text:"<?php echo $result->city_name; ?>" } 
                });
            });
    </script>
    </body>
