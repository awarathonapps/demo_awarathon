      ...
      <div class="page-container">
         ...
         <div class="page-content-wrapper">
            <div class="page-content">
               ...
               <!-- </form> -->
               <br>
               <!-- Top Five region Graph start here -->
               <!-- <div class='row'>
                  <div class='col-md-12'>
                     <div class='title-bar'>
                        <span class="caption-subject font-dark bold" style="font-family:'Catamaran'; position: absolute; top: 22px; left: 14px;">Top Five region based on overall scores
