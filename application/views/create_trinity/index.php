                    ...
                    <div class="page-bar">
                        ...
                        <?php if ($acces_management->allow_add) { ?>
                            <div class="page-toolbar">
                                <a href="<?php echo $base_url . 'create_trinity/create'; ?>" class="btn btn-sm btn-orange pull-right">Create New</a>&nbsp;
                                <!-- <a href="< ?php echo $base_url.'create_trinity/create_assessment' ;?>" class="btn btn-sm btn-orange pull-right">Create New</a>&nbsp; -->
                            </div>
                        <?php } ?>
                    </div>
                    <div class="row mt-10">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet light bordered">
                                ...
                                <div class="portlet-body">
                                    <form id="frmAssessment" name="frmAssessment" method="post" action="<?php echo base_url() . 'create_trinity/export_assessment/' ?>">
    ...
    <script>
                        ...
                        action: function() {
                            if (opt != 4) {
                                $.ajax({
                                    ...
                                    url: "<?php echo base_url(); ?>create_trinity/record_actions/" + opt,
                ...
                buttons: {
                    confirm: {
                        ...
                        action: function() {
                            $.ajax({
                                type: "POST",
                                url: "<?php echo base_url(); ?>create_trinity/remove/" + Id,
                                success: function(response_json) {
                                    var response = JSON.parse(response_json);
                                    ShowAlret(response.message, response.alert_type);
                                    DatatableRefresh();
        ...
        function DatatableRefresh() {
            ...
            table.dataTable({
                ...
                "processing": true,
                "serverSide": true,
                "sAjaxSource": "<?php echo base_url() . 'create_trinity/DatatableRefresh'; ?>",
