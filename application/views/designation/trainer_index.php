        ...
        <script>
            ...
            jQuery(document).ready(function() {                                                
                ...
                $.ajax({
                    ...
                    url: "<?php echo base_url(); ?>designation/trainer_check_designation",
                    async: false,
            ...
            , "Designation are already exists!!!");
                ...
                frmModalForm.validate({
                    ...
                    submitHandler: function (form) {
                        ...
                        form_success.show();
                        form_error.hide();
                        $.post('<?php echo base_url();?>index.php/designation/trainer_submit', $("#frmModalForm").serialize(), function (data) {
            ...
            function LoadEditModal(edit_id){                
                ...
                $.ajax({
                    ...
                    url: "<?php echo $base_url; ?>designation/trainer_edit",
                    ...
                    buttons: {
                        ...
                        action: function(){
                            $.ajax({
                                ...
                                url: "<?php echo $base_url; ?>designation/trainer_record_actions/"+opt,
                                success: function (response_json) {
                                    var response= JSON.parse(response_json);
                                    ShowAlret(response.message,response.alert_type);
                                    DatatableRefresh();
                ...
                $.confirm({
                    ...
                    buttons: {
                        ...
                        action: function(){
                            $.ajax({
                                type: "POST",
                                url: "<?php echo $base_url;?>designation/trainer_remove",
                                data: {deleteid:Id},
                                success: function (response_json) {
                                    var response= JSON.parse(response_json);
                                    ShowAlret(response.message,response.alert_type);
...
//                }
                ...
                table.dataTable({
                    ...
                    "processing": true,
                    "serverSide": true,
                    "sAjaxSource": "<?php echo base_url() . 'designation/trainer_DatatableRefresh'; ?>",
