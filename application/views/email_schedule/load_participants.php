    ...
    <div class="kt-portlet__head">
        <div class="kt-portlet__head-label">
            <h3 class="kt-portlet__head-title">
                ...
                <span style="height: 25px;width: 25px;background: #ff2292;padding: 9px;color: #ffffff;">GRP</span> Generate Report Pending 
                <span style="height: 25px;width: 25px;background: #ff5722;padding: 9px;color: #ffffff;">SP</span> Schedule Pending 
                <span style="height: 25px;width: 25px;background: #4caf50;padding: 9px;color: #ffffff;">RP</span> Rating Pending
                </div>
            </h3>
        </div>
    </div>
