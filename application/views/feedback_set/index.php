                    ...
                    <div class="page-content">
                        ...
                        <div class="page-bar">
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <span>Feedback Set Listing</span>
                                </li>
                            </ul>
                            <?php if($acces_management->allow_add){ ?>
                            <div class="page-toolbar">
                                <a href="<?php echo $base_url?>feedback_set/create" class="btn btn-sm btn-orange pull-right">Create New</a>&nbsp;
                            </div>
                            <?php } ?>
                        </div>
                        <div class="row mt-10">
                                                ...
                                                <div class="row">                               
                                                    ...
                                                    <div class="col-md-6">       
                                                            <div class="form-group">
                                                                ...
                                                                <select id="company_id" name="company_id" class="form-control input-sm select2" placeholder="Please select" >
                                                                    <option value="" selected="">All <option>
                                                                    <?php if(isset($CompnayResultSet)){
...
<script src="<?php echo $asset_url; ?>assets/global/plugins/datatables/Buttons-1.3.1/js/dataTables.buttons.min.js" type="text/javascript"></script>
        <script>
                    ...
                    buttons: {
                        ...
                        action: function(){
                            $.ajax({
                                ...
                                url: "<?php echo $base_url; ?>feedback_set/record_actions/"+opt,
                                beforeSend: function () {
                                	customBlockUI();
                                },
                ...
                if (Check > 0){
                    if( opt == 1 ){
                       LoadConfirmDialog("Confirm Active Status ?",opt);  
                        ...
                        LoadConfirmDialog("Delete Selected Feedback Set(s) ?",opt);
                    }   
                }else{
            ...
            function LoadDeleteDialog(name,Id){
                $.confirm({
                    title: 'Confirm!',
                    content: " Are you sure you want to delete Feedback Set '"+name+"' ? ",
                    buttons: {
                        confirm:{
                        text: 'Confirm',
                        btnClass: 'btn-orange',
                        ...
                        action: function(){
                            $.ajax({
                                type: "POST",
                                url: "<?php echo $base_url;?>feedback_set/remove",
                                data: {deleteid:Id},
                                beforeSend: function () {
                                	customBlockUI();
                                },
            ...
            function DatatableRefresh() {            
                ...
                table.dataTable({
                    ...
                    "columnDefs": [
                        ...
                        {'width': '20px','orderable': true,'searchable': true,'targets': [3]}, 
                        {'width': '150px','orderable': true,'searchable': true,'targets': [4]},
                        {'width': '80px','orderable': true,'searchable': true,'targets': [5]}, 
                        {'width': '60px','orderable': true,'searchable': true,'targets': [6]},
                        {'width': '60px','orderable': true,'searchable': true,'targets': [7]},
                        {'width': '60px','orderable': false,'searchable': false,'targets': [8]}
                    ...
                    "processing": true,
                    "serverSide": true,
                    "sAjaxSource": "<?php echo base_url() . 'feedback_set/DatatableRefresh'; ?>",
                    "fnServerData": function (sSource, aoData, fnCallback) {
                        aoData.push({name: '__mode', value: 'featuredimage.ajaxload'});
                        aoData.push({name: 'filter_company_id', value: $('#company_id').val()});                        
