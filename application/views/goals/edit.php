...
<html lang="en">
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
                    ...
                    <div class="page-content">
                        <div class="page-bar">
                            ...
                            <div class="page-toolbar">
                                <a href="<?php echo $base_url ?>goals" class="btn btn-sm btn-default pull-right">Back</a>&nbsp;
                            </div>
                        </div>
                        <div class="row mt-10">
                            <div class="col-md-12">
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="row">      
                                                <div class="col-md-12 text-right">  
                                                    <button type="button" id="goal-submit" name="goal-submit" data-loading-text="Please wait..." class="btn btn-orange mt-ladda-btn ladda-button mt-progress-demo" data-style="expand-left" onclick="update_parameter();">
                                                        <span class="ladda-label">Update</span>
                                                    </button>
                                                    <a href="<?php echo site_url("goals"); ?>" class="btn btn-default btn-cons">Cancel</a>
                                                </div>
                                            </div>
                                        </form>                                                                                    
                                    </div>
        ...
        jQuery(document).ready(function() {   
            frmAIMethod.validate({
                ...
                submitHandler: function (form) {
                    form_success.show();
                    form_error.hide();
                    Ladda.bind('button[id=goal-submit]');
                    form.submit();
                }
            });
            jQuery.validator.addMethod("subparameterCheck", function (value, element) {
                ...
                $.ajax({
                    ...
                    url: "<?php echo base_url(); ?>goals/Check_subparameter",
                    async: false,
        ...
        function update_parameter() {
            ...
            $.ajax({
                type: "POST",
                url: '<?php echo base_url(); ?>goals/update/<?php echo base64_encode($result->id) ?>',
                ...
                success: function (Odata) {
                    ...
                    if (Data['success']) {
						...
						window.location.href = base_url + 'goals';                                                                                            
                    } else {
                        $('#errordiv').show();
