...
<div class="page-sidebar-wrapper">
    <div class="page-sidebar navbar-collapse collapse">
        <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 0px">
            ...
            <?php } ?>
            <?php if ($SupperAccess || isset($GrouprightSet['Trinity'])) { ?>
                <li class="nav-item start <?php echo (($module_id == '87' or $module_id == '88' or $module_id == '89' or $module_id == '90' or $module_id == '92') ? 'active open' : ''); ?>">
                    <a href="javascript:;" class="nav-link nav-toggle">
                        <i class="icon-settings"></i>
                        <span class="title">Trinity</span>
                        <span class="arrow <?php echo (($module_id == '87' or $module_id == '88' or $module_id == '89' or $module_id == '90' or $module_id == '92') ? 'open' : ''); ?>"></span>
                    </a>
                    <ul class="sub-menu">
                        <?php if ($SupperAccess || isset($SideBarDataSet['trinity_parameter'])) { ?>
                                                <li class="nav-item start <?php echo (($module_id == '87') ? 'active open' : ''); ?>">
                        ...
                        <?php if ($SupperAccess || isset($SideBarDataSet['goals'])) { ?>
                                                <li class="nav-item start <?php echo (($module_id == '88') ? 'active open' : ''); ?>">
                        ...
                        <?php if ($SupperAccess || isset($SideBarDataSet['upload_script'])) { ?>
                                                <li class="nav-item start <?php echo (($module_id == '89') ? 'active open' : ''); ?>">
                        ...
                        <?php if ($SupperAccess || isset($SideBarDataSet['create_trinity'])) { ?>
                                                <li class="nav-item start <?php echo (($module_id == '90') ? 'active open' : ''); ?>">
                        ...
                        <?php if ($SupperAccess || isset($SideBarDataSet['view_trinity'])) { ?>
                                                <li class="nav-item start <?php echo (($module_id == '92') ? 'active open' : ''); ?>">
            ...
            <?php if (
                ...
                <?php if ($SupperAccess || $administrator_module_access || isset($GrouprightSet['Jarvis'])) { ?>
                    <li class="nav-item start <?php echo (($module_id == '14.01' || $module_id == '14.02' || $module_id == '14.03') ? 'active open' : ''); ?>">
                        <a href="javascript:;" class="nav-link nav-toggle">
                            <i class="icon-globe"></i>
                            <span class="title">Jarvis</span>
                            <span class="arrow <?php echo (($module_id == '14.01' || $module_id == '14.02' || $module_id == '14.03') ? 'open' : ''); ?>"></span>
                        </a>
                        <ul class="sub-menu">
            ...
            <?php if ($SupperAccess || $administrator_module_access || isset($GrouprightSet['Api Documentation'])) { ?>
                    ...
                    <a href="<?php echo site_url("api_documantation"); ?>" class="nav-link nav-toggle">
                            <i class="icon-globe"></i>
            ...
            <?php if ($admin_manager || $SupperAccess || $administrator_module_access || (isset($SideBarDataSet['reports']) && isset($GrouprightSet['Main Reports']))) { ?>
                        <li class="nav-item start <?php echo (($module_id == '91') ? 'active open' : ''); ?>">
