                                                    ...
                                                    <div class="row">    
                                                        <div class="col-md-9">       
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="language_id" id="language_id" maxlength="250" class="form-control input-sm" autocomplete="off">
...
<script src="<?php echo $asset_url; ?>assets/global/plugins/datatables/Buttons-1.3.1/js/dataTables.buttons.min.js" type="text/javascript"></script>
        <script>
            ...
            jQuery(document).ready(function() {
                ...
                jQuery.validator.addMethod("languageCheck", function(value, element){                   
                var isSuccess = false;   
//                console(language_edit_id);
                $.ajax({
                    type: "POST",
                    data: {language_id:value,language_Eid:language_edit_id},
                    url: "<?php echo base_url(); ?>language/Check_Language",
                    async: false,
            ...
            , "Same Language already exists..!!");
                frmModalForm.validate({
                    ...
                    submitHandler: function (form) {
                        ...
                        form_success.show();
                        form_error.hide();
                        $.post('<?php echo base_url();?>index.php/language/submit', $("#frmModalForm").serialize(), function (data) {
...
//                                    document.getElementById('dsk').innerHTML = '<div class="alert alert-success alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true"></button>' + data.message + '</div>';
                    ...
                    messages: {
                        language_id: {
                            ...
                            remote: "This same Language name already exists. Please try another Name."
                        },
            ...
            function LoadCreateModal(){
                $('.modal-title').html('Create Language').show();
            ...
            function LoadEditModal(edit_id){
                language_edit_id=edit_id;
                $('.modal-title').html('Edit Language').show();
                $('#frmModalForm').trigger("reset");
                $("#frmModalForm").validate().resetForm();
                $("#status").select2("val", "1");
                $('#edit_id').val(edit_id);
                $.ajax({
                    ...
                    url: "<?php echo $base_url; ?>language/edit",
                    beforeSend: function () {
                    	customBlockUI();
                    },
                    success: function (response_json) {
                        ...
                        if (response.message==''){                           
                            ...
                            $('#language_id').val(response.result[0].name);
                    ...
                    buttons: {
                        ...
                        action: function(){
                            $.ajax({
                                ...
                                url: "<?php echo $base_url; ?>language/record_actions/"+opt,
                                beforeSend: function () {
                                	customBlockUI();
                                },
                                success: function (response_json) {
                ...
                if (Check > 0){
                    if( opt == 1 ){
                       LoadConfirmDialog("Confirm Active Status ?",opt);  
                        ...
                        LoadConfirmDialog("Delete Selected Language(s) ?",opt);
                    }   
                }else{
            ...
            function LoadDeleteDialog(Language,Id){
                $.confirm({
                    title: 'Confirm!',
                    content: " Are you sure you want to delete Language '"+Language+"' ? ",
                    buttons: {
                        confirm:{
                        text: 'Confirm',
                        btnClass: 'btn-orange',
                        ...
                        action: function(){
                            $.ajax({
                                type: "POST",
                                url: "<?php echo $base_url;?>language/remove",
                                data: {deleteid:Id},
                                beforeSend: function () {
                                	customBlockUI();
                                },
...
//                }
                ...
                table.dataTable({
                    ...
                    "processing": true,
                    "serverSide": true,
                    "sAjaxSource": "<?php echo base_url() . 'language/DatatableRefresh'; ?>",
