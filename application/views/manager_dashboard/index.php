                ...
                <div class="page-content-wrapper">
                    <div class="page-content">
                        ...
                        <form id="FilterFrm" name="FilterFrm" method="post">
                            ...
                            <!-- PAGE BAR -->      
                            <h1 class="page-title">
                             Manager Dashboard <small>reports &amp; statistics</small>
                            </h1>
                                                                ...
                                                                <div class="form-group">
                                                                    <label class="control-label">Assessment&nbsp;<span class="required"> </label>
                                                                        <select id="assessment_id1" name="assessment_id1" class="form-control input-sm select2me" style="width: 100%">
                                                                            ...
                                                                            <?php } ?> -->
                                                                            <?php 
                                                                            foreach ($assessment_data as $val) { ?>
                                                                                <option value="<?= $val->assessment_id; ?>"><?php echo '['.$val->assessment_id.'] - '. $val->assessment; ?></option>
                                                                            <?php } ?>
                                                                        </select>
                                                                </div>
                                                            </div>      
...
<!--        <script src="< ?php echo $asset_url;?>assets/global/highcharts/highcharts.js"></script>-->
        ...
        <script src="<?php echo $asset_url; ?>assets/customjs/manager_dashboard.js"></script>
        <script>
                ...
                function getAssessmentwiseData(){                
                    ...
                    $.ajax({
                        type: "POST",
                        data: {company_id: compnay_id,userid_id: $('#supervisor_id').val(), startDate: StartDate},
                        //async: false,
                        url: "<?php echo $base_url; ?>manager_dashboard/ajax_assessmentwise_data",
                        beforeSend: function () {
                            customBlockUI();
                        },
