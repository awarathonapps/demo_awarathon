                    ...
                    <div class="page-content">
                        ...
                        <div class="page-bar">
                            ...
                            <div class="page-toolbar">
                                <a href="<?php echo $base_url?>parameter/create" class="btn btn-sm btn-orange pull-right">Create New</a>&nbsp;
                            </div>
                            <?php } ?>
                        </div>
                        <div class="row mt-10">
    ...
    <script>
                ...
                buttons: {
                    ...
                    action: function(){
                        $.ajax({
                            ...
                            url: "<?php echo $base_url; ?>parameter/record_actions/"+opt,
                            beforeSend: function () {
                                customBlockUI();
                            },
            ...
            $.confirm({
                ...
                buttons: {
                    ...
                    action: function(){
                        $.ajax({
                            type: "POST",
                            url: "<?php echo $base_url;?>parameter/remove",
                            data: {deleteid:Id},
                            beforeSend: function () {
                                customBlockUI();
                            },
        ...
        function DatatableRefresh() {            
            ...
            table.dataTable({
                ...
                "processing": true,
                "serverSide": true,
                "sAjaxSource": "<?php echo base_url() . 'parameter/DatatableRefresh'; ?>",
