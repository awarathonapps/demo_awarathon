...
<html lang="en">
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
                    ...
                    <div class="page-content">
                        ...
                        <div class="page-bar">
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <span>Edit Parameter Label</span>
                                </li>
                            </ul>
                            <div class="page-toolbar">
                                <a href="<?php echo $base_url ?>parameterlabel" class="btn btn-sm btn-default pull-right">Back</a>&nbsp;
                            </div>
                        </div>
                        <div class="row mt-10">
                            <div class="col-md-12">
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane active" id="tab_overview">                                                    
															...
															<div class="form-group">
																...
																<select name="parameter_id" id="parameter_id" class="form-control input-sm select2">
																	...
																	<?php foreach ($parameter_result as $param) { ?>
																		<option value="<?php echo $param->id ?>" <?php echo ($param->id == $result->parameter_id)?'selected':'';?> ><?php echo $param->description ?></option>
																	<?php } ?>
																</select>
															</div>
														</div>                                                    
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">    
                                                            <div class="form-group">
                                                                <label>Parameter Label<span class="required"> * </span></label>
                                            ...
                                            <div class="row">      
                                                <div class="col-md-12 text-right">  
                                                    <button type="button" id="parameterlabel-submit" name="parameterlabel-submit" data-loading-text="Please wait..." class="btn btn-orange mt-ladda-btn ladda-button mt-progress-demo" data-style="expand-left" onclick="update_parameter();">
                                                        <span class="ladda-label">Update</span>
                                                    </button>
                                                    <a href="<?php echo site_url("parameterlabel"); ?>" class="btn btn-default btn-cons">Cancel</a>
                                                </div>
                                            </div>
                                        </form>                                                                                    
                                    </div>
        ...
        jQuery(document).ready(function() {   
            frmAIMethod.validate({
                ...
                submitHandler: function (form) {
                    form_success.show();
                    form_error.hide();
                    Ladda.bind('button[id=parameterlabel-submit]');
                    form.submit();
                }
            });
            jQuery.validator.addMethod("subparameterCheck", function (value, element) {
                ...
                $.ajax({
                    type: "POST",
                    data: {description: value, subparameter_id:<?php echo $result->id ?>},
                    url: "<?php echo base_url(); ?>parameterlabel/Check_subparameter",
                    async: false,
            ...
            , "Parameter Label already exists!!!");
        });   
        function update_parameter() {
            ...
            $.ajax({
                type: "POST",
                url: '<?php echo base_url(); ?>parameterlabel/update/<?php echo base64_encode($result->id) ?>',
                ...
                success: function (Odata) {
                    ...
                    if (Data['success']) {
						...
						window.location.href = base_url + 'parameterlabel';                                                                                            
                    } else {
                        $('#errordiv').show();
