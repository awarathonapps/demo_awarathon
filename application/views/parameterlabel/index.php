                    ...
                    <div class="page-content">
                        ...
                        <div class="page-bar">
                            ...
                            <div class="page-toolbar">
                                <a href="<?php echo $base_url?>parameterlabel/create" class="btn btn-sm btn-orange pull-right">Create New</a>&nbsp;
                            </div>
                            <?php } ?>
                        </div>
                        <div class="row mt-10">
...
<script src="<?php echo $asset_url; ?>assets/global/plugins/datatables/Buttons-1.3.1/js/dataTables.buttons.min.js" type="text/javascript"></script>
    <script>
                ...
                buttons: {
                    ...
                    action: function(){
                        $.ajax({
                            ...
                            url: "<?php echo $base_url; ?>parameterlabel/record_actions/"+opt,
                            beforeSend: function () {
                                customBlockUI();
                            },
            ...
            if (Check > 0){
                if( opt == 1 ){
                   LoadConfirmDialog("Confirm Active Status ?",opt);  
                    ...
                    LoadConfirmDialog("Delete Selected Parameter Label(s) ?",opt);
                }   
            }else{
        ...
        function LoadDeleteDialog(name,Id){
            $.confirm({
                title: 'Confirm!',
                content: " Are you sure you want to delete Parameter Label '"+name+"' ? ",
                buttons: {
                    confirm:{
                    text: 'Confirm',
                    btnClass: 'btn-orange',
                    ...
                    action: function(){
                        $.ajax({
                            type: "POST",
                            url: "<?php echo $base_url;?>parameterlabel/remove",
                            data: {deleteid:Id},
                            beforeSend: function () {
                                customBlockUI();
                            },
        ...
        function DatatableRefresh() {            
            ...
            table.dataTable({
                ...
                "processing": true,
                "serverSide": true,
                "sAjaxSource": "<?php echo base_url() . 'parameterlabel/DatatableRefresh'; ?>",
