                    ...
                    <div class="page-content">
                        ...
                        <div class="page-bar">
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <span>Question Set Listing</span>
                                </li>
                            </ul>
                            <?php if($acces_management->allow_add){ ?>
                            <div class="page-toolbar">
                                <a href="<?php echo $base_url?>questionset/create" class="btn btn-sm btn-orange pull-right">Create New</a>&nbsp;
                            </div>
                            <?php } ?>
                        </div>
                        <div class="row mt-10">
    ...
    jQuery(document).ready(function() {
        ...
        DatatableRefresh();
                    ...
                    buttons: {
                        ...
                        action: function(){
                            $.ajax({
                                ...
                                url: "<?php echo $base_url; ?>questionset/record_actions/"+opt,
                                beforeSend: function () {
                                customBlockUI();
                                },
            ...
            function LoadDeleteDialog(Id){
                $.confirm({
                    title: 'Confirm!',
                    content: " Are you sure want to delete this Question set.? ",
                    buttons: {
                        confirm:{
                        text: 'Confirm',
                        btnClass: 'btn-orange',
                        ...
                        action: function(){
                            $.ajax({
                                type: "POST",
                                url: "<?php echo $base_url;?>questionset/remove",
                                data: {deleteid:Id},
                                beforeSend: function () {
	customBlockUI();
},
...
//                }            
                ...
                table.dataTable({
                    ...
                    "columnDefs": [
                        ...
                        {'width': '120px','orderable': true,'searchable': true,'targets': [4]},
                        {'width': '30px','orderable': true,'searchable': true,'targets': [5]}, 
                        {'width': '60px','orderable': false,'searchable': true,'targets': [6]}, 
                        {'width': '60px','orderable': false,'searchable': true,'targets': [7]},
