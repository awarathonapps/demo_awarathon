                                                    ...
                                                    <div class="row">    
                                                        <div class="col-md-9">       
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="region_name" id="region_name" maxlength="250" class="form-control input-sm" autocomplete="off">
...
<script src="<?php echo $asset_url; ?>assets/global/plugins/datatables/Buttons-1.3.1/js/dataTables.buttons.min.js" type="text/javascript"></script>
        <script>
            ...
            jQuery(document).ready(function() {
                ...
                jQuery.validator.addMethod("regionTypeCheck", function(value, element){                   
                var isSuccess = false;   
                $.ajax({
                    type: "POST",
                    data: {region_name:value,id:region_edit_id,company_id:$('#company_id').val()},
                    url: "<?php echo base_url(); ?>region/Check_Region",
                    async: false,
            ...
            , "Region name already exists..!!");
                ...
                frmModalForm.validate({
                    ...
                    submitHandler: function (form) {
                        ...
                        form_success.show();
                        form_error.hide();
                        $.post('<?php echo base_url();?>index.php/region/submit', $("#frmModalForm").serialize(), function (data) {
                    ...
                    messages: {
                        region_name: {
                            ...
                            remote: "This same Region name already exists. Please try another Name."
                        },
            ...
            function LoadEditModal(edit_id){
                ...
                $('.modal-title').html('Edit Region').show();
                $('#frmModalForm').trigger("reset");
                $("#frmModalForm").validate().resetForm();
                $("#status").select2("val", "1");
                $('#edit_id').val(edit_id);
                $.ajax({
                    ...
                    url: "<?php echo $base_url; ?>region/edit",
                    beforeSend: function () {
                    	customBlockUI();
                    },
                    success: function (response_json) {
                        ...
                        if (response.message==''){
                             region_edit_id = response.result[0].id;
                             $("#company_id").select2("trigger", "select", { 
                                data: { id: response.result[0].company_id,text:response.result[0].company_name} 
                            });
                            $('#region_name').val(response.result[0].region_name);
                    ...
                    buttons: {
                        ...
                        action: function(){
                            $.ajax({
                                ...
                                url: "<?php echo $base_url; ?>region/record_actions/"+opt,
                                beforeSend: function () {
                                	customBlockUI();
                                },
                                success: function (response_json) {
                ...
                if (Check > 0){
                    if( opt == 1 ){
                       LoadConfirmDialog("Confirm Active Status ?",opt);  
                        ...
                        LoadConfirmDialog("Delete Selected Region(s) ?",opt);
                    }   
                }else{
                ...
                $.confirm({
                    ...
                    buttons: {
                        ...
                        action: function(){
                            $.ajax({
                                type: "POST",
                                url: "<?php echo $base_url;?>region/remove",
                                data: {deleteid:Id},
                                beforeSend: function () {
                                	customBlockUI();
                                },
            ...
            {
                var x = 0;
                for (var i = 0; i < frmRegion.elements.length; i++)
                {
                    if (frmRegion.elements[i].checked == true)
                    {
                        x++;
                    }
                }
...
//                }
                ...
                table.dataTable({
                    ...
                    "processing": true,
                    "serverSide": true,
                    "sAjaxSource": "<?php echo base_url() . 'region/DatatableRefresh'; ?>",
