...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid page-content-white">
                  ...
                  <div class='col-md-12'>
                     <div class='title-bar'>
                        ...
                        <div style="width:99%;padding-top: 115px;font-size: 12px;">
                           <form id="frmUsers" name="frmUsers" method="post" action="<?php echo base_url() . 'reports_competency/export_rockstar_users' ?>">
               ...
               <div class='row'>
                  <div class='col-md-12'>
                     <div class='title-bar'>
                        ...
                        <!-- Table start here -->
                        <div style="width:99%;padding-top: 115px;font-size: 12px;">
                           <form id="frmUsersAt_risk" name="frmUsersAt_risk" method="post" action="<?php echo base_url() . 'reports_competency/export_at_risk_user' ?>">
                  ...
                  <div class='col-md-12'>
                     <div class='title-bar'>
                        ...
                        <div style="width:99%;padding-top: 58px;font-size: 12px;">
                           <form id="manager_understanding" name="manager_understanding" method="post" action="<?php echo base_url() . 'reports_competency/export_manager_data' ?>">
            ...
            <form id="frmModalForm" name="frmModalForm" onsubmit="return false;">
               ...
               <div class="modal-body">
                  ...
                  <div class="row">
                     <div class="col-md-11">
                        <div class="form-group last">
                           <label>Region<p style="color: red;position: absolute;top: -23px;left: 54px;font-size: 21px;">* </p><span style="position: absolute;top: 2px;left: 62px;color: red;font-size: 8px;"> (Mandatory)</span></label>
            ...
            <form id="frmModalForm" name="frmModalForm" onsubmit="return false;">
               ...
               <div class="modal-body">
                  ...
                  <div class="row">
                     <div class="col-md-11">
                        <div class="form-group last">
                           <label>Manager <p style="color: red;position: absolute;top: -22px;left: 64px;font-size: 21px;">* </p><span style="position: absolute;top: 4px;left: 73px;color: red;font-size: 8px;"> (Mandatory)</span></label>
            ...
            <form id="frmModalForm" name="frmModalForm" onsubmit="return false;">
               ...
               <div class="modal-body">
                  ...
                  <div class="row">
                     <div class="col-md-11">
                        <div class="form-group last">
                           <label>Modules<p style="color: red;position: absolute;top: -23px;left: 61px;font-size: 21px;">* </p><span style="position: absolute;top: 2px;left: 70px;color: red;font-size: 8px;"> (Mandatory)</span></label>
            ...
            <form id="frmModalForm" name="frmModalForm" onsubmit="return false;">
               ...
               <div class="modal-body">
                  ...
                  <div class="row">
                     <div class="col-md-11">
                        <div class="form-group last">
                           <label>Modules<p style="color: red;position: absolute;top: -22px;left: 63px;font-size: 21px;">* </p><span style="position: absolute;top: 4px;left: 72px;color: red;font-size: 8px;"> (Mandatory)</span></label>
            ...
            <form id="frmModalForm" name="frmModalForm" onsubmit="return false;">
               ...
               <div class="modal-body">
                  ...
                  <div class="row">
                     <div class="col-md-11">
                        <div class="form-group last">
                           <label>Division<p style="color: red;position: absolute;top: -23px;left: 58px;font-size: 21px;">* </p><span style="position: absolute;top: 2px;left: 68px;color: red;font-size: 8px;"> (Mandatory)</span></label>
            ...
            <form id="frmModalForm" name="frmModalForm" onsubmit="return false;">
               ...
               <div class="modal-body">
                  ...
                  <div class="row">
                     <div class="col-md-11">
                        <div class="form-group last">
                           <label>Region<p style="color: red;position: absolute;top: -23px;left: 53px;font-size: 21px;">* </p><span style="position: absolute;top: 2px;left: 62px;color: red;font-size: 8px;"> (Mandatory)</span></label>
   ...
   <script src="<?php echo $asset_url; ?>assets/customjs/reports_competency.js"></script>
   ...
   <script>
      ...
      //       },
      //       //async: false,
      //       url: "< ?php echo $base_url; ?>reports_competency/assessment_wise_division",
      //       beforeSend: function() {
      //          customBlockUI();
      //       },
      ...
      function load_division_time_based(IsCustom) {
         ...
         $.ajax({
            ...
            //async: false,
            url: "<?php echo $base_url; ?>reports_competency/load_division_time_based",
            beforeSend: function() {
               customBlockUI();
            },
            success: function(msg) {
      ...
      function load_division() {
         ...
         $.ajax({
            ...
            //async: false,
            url: "<?php echo $base_url; ?>reports_competency/competency_by_division_filter",
            beforeSend: function() {
               customBlockUI();
            },
            success: function(msg) {
      ...
      function load_region_time_based(IsCustom) {
         ...
         $.ajax({
            ...
            //async: false,
            url: "<?php echo $base_url; ?>reports_competency/load_region_time_based",
            beforeSend: function() {
               customBlockUI();
            },
            success: function(msg) {
      ...
      function load_region_filter() {
         ...
         $.ajax({
            ...
            //async: false,
            url: "<?php echo $base_url; ?>reports_competency/competency_by_region_filter",
            beforeSend: function() {
               customBlockUI();
            },
            success: function(msg) {
      ...
      //       },
      //       //async: false,
      //       url: "< ?php echo $base_url; ?>reports_competency/assessment_wise_region",
      //       beforeSend: function() {
      //          customBlockUI();
      //       },
      //       success: function(msg) {
      ...
      function Getassessment_region() {
         ...
         $.ajax({
            ...
            //async: false,
            url: "<?php echo $base_url; ?>reports_competency/am_wise_region",
            beforeSend: function() {
               customBlockUI();
            },
            success: function(msg) {
      ...
      function DatatableRefresh_Rockstars() {
         ...
         table.dataTable({
            ...
            // "serverSide": true,
            "serverSide": false,
            "sAjaxSource": "<?php echo base_url() . 'reports_competency/get_rockstars_user_score'; ?>",
      ...
      function DatatableRefresh_Atrisk() {
         ...
         table.dataTable({
            ...
            "sAjaxSource": "<?php echo base_url() . 'reports_competency/get_at_risk_user_score'; ?>",
            "fnServerData": function(sSource, aoData, fnCallback) {
               aoData.push({
                  name: 'assessment_id',
      ...
      function GetAssessmentWiseManager(manager_set) {
         ...
         $.ajax({
            ...
            //async: false,
            url: "<?php echo $base_url; ?>reports_competency/assessment_wise_manager",
            beforeSend: function() {
               customBlockUI();
            },
            success: function(msg) {
      ...
      function manager_wise_understanding(IsCustom) {
         ...
         table.dataTable({
            ...
            // "serverSide": true,
            "serverSide": false,
            "sAjaxSource": "<?php echo base_url() . 'reports_competency/get_manager_data'; ?>",
            "fnServerData": function(sSource, aoData, fnCallback) {
               aoData.push({
                  name: 'assessment_id',
      ...
      function getdashboardData() {
         ...
         $.ajax({
            ...
            //async: false,
            url: "<?php echo $base_url; ?>reports_competency/get_heatmap_data",
            beforeSend: function() {
               customBlockUI();
            },
            success: function(msg) {
