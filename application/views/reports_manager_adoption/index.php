...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid page-content-white">
               ...
               <form id="FilterFrm" name="FilterFrm" method="post">
                  ...
                  <div class="row" style="display: -webkit-box; overflow-x: auto;">
                     ...
                     <div class="col-lg-5 col-xs-12 col-sm-12">
                        ...
                        <div id='reports_manager_adoption_by_module'></div>
                        <br>
                     </div>
   ...
   <script src="<?php echo $asset_url; ?>assets/customjs/reports_manager_adoption.js"></script>
   <script>
      ...
      function Manager_wise_usesr() {
         ...
         $.ajax({
            ...
            //async: false,
            url: "<?php echo $base_url; ?>reports_manager_adoption/manager_wise_users",
            beforeSend: function() {
               customBlockUI();
            },
