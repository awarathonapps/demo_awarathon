                                            ...
                                            <form id="frmModalForm" name="frmModalForm" onsubmit="return false;"> 
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="row">    
                                                        <div class="col-md-9">       
                                                            <div class="form-group">
                                                                <label class="">Store<span class="required"> * </span></label>
                                                                <input type="text" name="store_id" id="store_id" maxlength="250" class="form-control input-sm" autocomplete="off">
...
<script src="<?php echo $asset_url; ?>assets/global/plugins/datatables/Buttons-1.3.1/js/dataTables.buttons.min.js" type="text/javascript"></script>
        <script>
            ...
            jQuery(document).ready(function() {
                ...
                jQuery.validator.addMethod("storeCheck", function(value, element){                   
                var isSuccess = false;   
//                console(store_edit_id);
                $.ajax({
                    type: "POST",
                    data: {store_id:value,store_Eid:store_edit_id,company_id:$('#company_id').val()},
                    url: "<?php echo base_url(); ?>store/Check_Store",
                    async: false,
            ...
            , "Same Store already exists..!!");
                frmModalForm.validate({
                    ...
                    submitHandler: function (form) {
                        ...
                        form_success.show();
                        form_error.hide();
                        $.post('<?php echo base_url();?>index.php/store/submit', $("#frmModalForm").serialize(), function (data) {
                    ...
                    messages: {
                        store_id: {
                            ...
                            remote: "This same Store name already exists. Please try another Name."
                        },
            ...
            function LoadCreateModal(){
                $('.modal-title').html('Create Store').show();
            ...
            function LoadEditModal(edit_id){
                store_edit_id=edit_id;
                $('.modal-title').html('Edit Store').show();
                $('#frmModalForm').trigger("reset");
                $("#frmModalForm").validate().resetForm();
                $("#status").select2("val", "1");
                $('#edit_id').val(edit_id);
                $.ajax({
                    ...
                    url: "<?php echo $base_url; ?>store/edit",
                    beforeSend: function () {
                    	customBlockUI();
                    },
                    success: function (response_json) {
                        ...
                        if (response.message==''){
                            ...
                            $('#edit_id').val(response.result[0].id);
                            $('#store_id').val(response.result[0].store_name);
                    ...
                    buttons: {
                        ...
                        action: function(){
                            $.ajax({
                                ...
                                url: "<?php echo $base_url; ?>store/record_actions/"+opt,
                                beforeSend: function () {
                                	customBlockUI();
                                },
                                success: function (response_json) {
                ...
                if (Check > 0){
                    if( opt == 1 ){
                       LoadConfirmDialog("Confirm Active Status ?",opt);  
                        ...
                        LoadConfirmDialog("Delete Selected Store(s) ?",opt);
                    }   
                }else{
                ...
                $.confirm({
                    ...
                    buttons: {
                        ...
                        action: function(){
                            $.ajax({
                                type: "POST",
                                url: "<?php echo $base_url;?>store/remove",
                                data: {deleteid:Id},
                                beforeSend: function () {
                                	customBlockUI();
                                },
...
//                }
                ...
                table.dataTable({
                    ...
                    "processing": true,
                    "serverSide": true,
                    "sAjaxSource": "<?php echo base_url() . 'store/DatatableRefresh'; ?>",
