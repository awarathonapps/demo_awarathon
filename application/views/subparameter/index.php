                    ...
                    <div class="page-content">
                        ...
                        <div class="page-bar">
                            ...
                            <div class="page-toolbar">
                                <!-- <a href="<?php //echo $base_url?>subparameter/create" class="btn btn-sm btn-orange pull-right">Create New</a>&nbsp; -->
                            </div>
                            <?php } ?>
                        </div>
                        <div class="row mt-10">
                                            ...
                                            <table class="table  table-bordered table-hover table-checkable order-column" id="index_table">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>Sub Parameter</th>
                                                        <th>Parameter</th>
                                                        <th>Allow to map Sentences / Keyword?</th>
                                                        <th>Status</th>
                                                        <!-- <th>Actions</th> -->
                                                    </tr>
                                                </thead>
...
<script src="<?php echo $asset_url; ?>assets/global/plugins/datatables/Buttons-1.3.1/js/dataTables.buttons.min.js" type="text/javascript"></script>
    <script>
                ...
                buttons: {
                    ...
                    action: function(){
                        $.ajax({
                            ...
                            url: "<?php echo $base_url; ?>subparameter/record_actions/"+opt,
                            beforeSend: function () {
                                customBlockUI();
                            },
            ...
            if (Check > 0){
                if( opt == 1 ){
                   LoadConfirmDialog("Confirm Active Status ?",opt);  
                    ...
                    LoadConfirmDialog("Delete Selected Sub Parameter(s) ?",opt);
                }   
            }else{
        ...
        function LoadDeleteDialog(name,Id){
            $.confirm({
                title: 'Confirm!',
                content: " Are you sure you want to delete Sub Parameter '"+name+"' ? ",
                buttons: {
                    confirm:{
                    text: 'Confirm',
                    btnClass: 'btn-orange',
                    ...
                    action: function(){
                        $.ajax({
                            type: "POST",
                            url: "<?php echo $base_url;?>subparameter/remove",
                            data: {deleteid:Id},
                            beforeSend: function () {
                                customBlockUI();
                            },
        ...
        function DatatableRefresh() {            
            ...
            table.dataTable({
                ...
                "columnDefs": [
                    ...
                    {'width': '300px','orderable': true,'searchable': false,'targets': [2]}, 
                    {'width': '100px','orderable': true,'searchable': false,'targets': [3]}, 
                ...
                "processing": true,
                "serverSide": true,
                "sAjaxSource": "<?php echo base_url() . 'subparameter/DatatableRefresh'; ?>",
