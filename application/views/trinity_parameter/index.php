                    ...
                    <div class="page-content">
                        ...
                        <div class="page-bar">
                            ...
                            <!-- <div class="page-toolbar">
                                <a href="<?php echo $base_url?>trinity" class="btn btn-sm btn-orange pull-right">Create New</a>&nbsp;
                            </div> -->
                            <?php } ?>
                        </div>
                        <div class="row mt-10">
													...
													<div class="row">                                                                                   
														...
														<div class="col-md-4">       
																	<div class="form-group">
																		...
																		<select id="filter_category_id" name="filter_category_id" class="form-control input-sm select2" placeholder="Please select" style="width:100%">
																			<option value="">All</option>
																			<?php //foreach ($category_set as $cmp) { ?>
																				<option value="<? //echo $cmp->id; ?>"><?php //echo $cmp->name; ?></option>
																			<?php //} ?>
																		</select>
																	</div>
																</div>
...
<script src="<?php echo $asset_url; ?>assets/global/plugins/datatables/Buttons-1.3.1/js/dataTables.buttons.min.js" type="text/javascript"></script>
    <script>
        var frmParameter = document.frmParameter;
                ...
                buttons: {
                    ...
                    action: function(){
                        $.ajax({
                            ...
                            url: "<?php echo $base_url; ?>trinity_parameter/record_actions/"+opt,
                            beforeSend: function () {
                                customBlockUI();
                            },
            ...
            if (Check > 0){
                if( opt == 1 ){
                   LoadConfirmDialog("Confirm Active Status ?",opt);  
                    ...
                    LoadConfirmDialog("Delete Selected Parameter(s) ?",opt);
                }   
            }else{
        ...
        function LoadDeleteDialog(name,Id){
            $.confirm({
                title: 'Confirm!',
                content: " Are you sure you want to delete Parameter '"+name+"' ? ",
                buttons: {
                    confirm:{
                    text: 'Confirm',
                    btnClass: 'btn-orange',
                    ...
                    action: function(){
                        $.ajax({
                            type: "POST",
                            url: "<?php echo $base_url;?>trinity_parameter/remove",
                            data: {deleteid:Id},
                            beforeSend: function () {
                                customBlockUI();
                            },
        ...
        function getCheckCount(){
            var x = 0;
            for (var i = 0; i < frmParameter.elements.length; i++){
                if (frmParameter.elements[i].checked == true){
                    x++;
                }
            }
            return x;
        ...
        function DatatableRefresh() {            
            ...
            table.dataTable({
                ...
                "columnDefs": [
                    ...
                    {'width': '30px','orderable': true,'searchable': true,'targets': [2], "visible": <?php echo ($Company_id == "" ? 'true' : 'false'); ?>},
                    {'width': '30px','orderable': true,'searchable': true,'targets': [3]}, 
                    {'width': '100px','orderable': true,'searchable': true,'targets': [4]}, 
                    {'width': '60px','orderable': true,'searchable': true,'targets': [5]},
                    {'width': '60px','orderable': true,'searchable': false,'targets': [6]},
					{'width': '60px','orderable': false,'searchable': false,'targets': [7]}
                ...
                "processing": true,
                "serverSide": true,
                "sAjaxSource": "<?php echo base_url() . 'trinity_parameter/DatatableRefresh'; ?>",
