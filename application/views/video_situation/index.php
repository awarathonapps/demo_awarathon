                    ...
                    <div class="page-content">
                        ...
                        <div class="page-bar">
                            ...
                            <div class="page-toolbar">
                                <a href="<?php echo $base_url?>video_situation/create" class="btn btn-sm btn-orange pull-right">Create New</a>&nbsp;
                            </div>
                            <?php } ?>
                        </div>
                        <div class="row mt-10">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <!-- <div class="col-md-3">    
                                                            <div class="form-group">
                                                                ...
                                                                <select id="question_type" name="question_type" class="form-control input-sm select2" >
                                                                    <option value="" selected="">All <option>
                            ...
                            <?php } ?>
                                <div class="portlet light bordered">
                                    ...
                                    <div class="portlet-body">
                                        <form id="frmVediosituation" name="frmVediosituation" method="post">
...
<script src="<?php echo $asset_url; ?>assets/global/plugins/datatables/Buttons-1.3.1/js/dataTables.buttons.min.js" type="text/javascript"></script>
    <script>
        var frmVediosituation = document.frmVediosituation;
            ...
            $.confirm({
                ...
                buttons: {
                    ...
                    action: function(){
                        $.ajax({
                            type: "POST",
                            data: $('#frmVediosituation').serialize(),
                            url: "<?php echo $base_url; ?>video_situation/record_actions/"+opt,
                            beforeSend: function () {
                                customBlockUI();
                            },
            ...
            if (Check > 0){
                if( opt == 1 ){
                   LoadConfirmDialog("Confirm Active Status ?",opt);  
                    ...
                    LoadConfirmDialog("Delete Selected Question(s) ?",opt);
                }   
            }else{
            ...
            $.confirm({
                ...
                buttons: {
                    ...
                    action: function(){
                        $.ajax({
                            type: "POST",
                            url: "<?php echo $base_url;?>video_situation/remove",
                            data: {deleteid:Id},
                            beforeSend: function () {
                                customBlockUI();
                            },
        ...
        function getCheckCount(){
            var x = 0;
            for (var i = 0; i < frmVediosituation.elements.length; i++){
                if (frmVediosituation.elements[i].checked == true){
                    x++;
                }
            }
            return x;
        ...
        function DatatableRefresh() {            
            ...
            table.dataTable({
                ...
                "columnDefs": [
                    ...
                    {'width': '70px','orderable': true,'searchable': true,'targets': [2]},
                    {'width': '250px','orderable': true,'searchable': true,'targets': [3]}, 
                    // {'width': '30px','orderable': true,'searchable': true,'targets': [4]}, 
                    {'width': '','orderable': true,'searchable': true,'targets': [4]},
                    {'width': '','orderable': true,'searchable': true,'targets': [5]},
                    {'width': '','orderable': true,'searchable': true,'targets': [6]},
                    {'width': '','orderable': true,'searchable': true,'targets': [7]},
                    {'width': '','orderable': false,'searchable': false,'targets': [8]},
                    {'width': '','orderable': false,'searchable': false,'targets': [9]}
                ],
                "order": [
                    [1, "desc"]
                ],
                "processing": true,
                "serverSide": true,
                "sAjaxSource": "<?php echo base_url() . 'video_situation/DatatableRefresh'; ?>",
