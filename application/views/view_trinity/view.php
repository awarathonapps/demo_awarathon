  ...
  background-color: #FFF;
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
                        ...
                        <div class="page-bar">
                            <ul class="page-breadcrumb">
                                <li>
                                    ...
                                    <span>Assessment</span>             DARSHIL COMMENTED AND ADDED BELOW    -->
                                    <span>View Trinity</span>
                                </li>
                                <li>
                                    <i class="fa fa-circle"></i>
                                    <!-- <span>Rating</span>             DARSHIL COMMENTED AND ADDED BELOW     -->
                                                            ...
                                                            <table class="table  table-bordered table-hover table-checkable order-column" id="AssessmentUsersTable">
                                                                <thead>
                                                                    <tr>                                                                                
                                                                        ...
                                                                        <?php //if($Rowset->assessment_type == 2) {?> 
                                                                            <!-- <th>Last played</th>  -->
                                                                        <?php //} ?>  <!-- Spotight - Add extra column --> 
                                                                        <!-- <th>Action</th> -->
                                                                    </tr>
                                                                </thead>
                                                                <tbody></tbody>
        ...
        jQuery(document).ready(function () {            
            AssessmentUsersRefresh();    //Spotlight - Pass assessment type to show columns
        });                       
        </script>
    </body>
</html>