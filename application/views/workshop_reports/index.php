                ...
                <div class="page-content">
                    ...
                    <div class="portlet-body">
                        <div class="tab-pane">
                            ...
                            <?php if ($role == 1 || (isset($acces_management_traineeplayed->allow_access) && $acces_management_traineeplayed->allow_access)){ ?>
                                <li class="active">
                                    <a href="#trainee_played_result_tab" data-toggle="tab">Trainee played</a>
                                </li>
                            <?php } if ($role == 1 || (isset($acces_management_traineesummary->allow_access) && $acces_management_traineesummary->allow_access)){ ?>
                                <li>
                                    <a href="#trainee_wise_summary_tab" data-toggle="tab">Summary Report</a>
                                </li>
                            <?php } if ($role == 1 || (isset($acces_management_traineetopic->allow_access) && $acces_management_traineetopic->allow_access)){ ?>
                                <li>
                                    <a href="#traineetopic_wise_report_tab" data-toggle="tab">Topic + Questions</a>
                                </li>
                            <?php } if ($role == 1 || (isset($acces_management_trainersummary->allow_access) && $acces_management_trainersummary->allow_access)){ ?>
                                <li>
                                    <a href="#trainer_wise_summary_report_tab" data-toggle="tab">Summary Report</a>
                                </li>
                            <?php } if ($role == 1 || (isset($acces_management_consolidate->allow_access) && $acces_management_consolidate->allow_access)){ ?>
                                <li>
                                    <a href="#trainer_consolidated_report_tab" data-toggle="tab">Consolidated Report</a>
                                </li>
                            <?php } if ($role == 1 || (isset($acces_management_workshop->allow_access) && $acces_management_workshop->allow_access)){ ?>
                                <li>
                                    <a href="#workshop_wise_report_tab" data-toggle="tab">Workshop-wise</a>
                                </li>
                            <?php } if ($role == 1 || (isset($acces_management_question->allow_access) && $acces_management_question->allow_access)){ ?>
                                <li>
                                    <a href="#question_wise_report_tab" data-toggle="tab">Question Wise</a>
                                </li>
                            <?php } if ($role == 1 || (isset($acces_management_device_emi->allow_access) && $acces_management_device_emi->allow_access)){ ?>
                                <li>
