function Save_rating() {
    ...
    $.ajax({
        url: Base_url + "assessment/save_rating/0",
        type: 'POST',
    ...
    $.confirm({
        ...
        buttons: {
            confirm: {
                ...
                action: function () {
                    $.ajax({
                        url: Base_url + "assessment/save_rating/1",
                        type: 'POST',
                        data: $('#VideoPitchingForm').serializeArray(),
                        beforeSend: function () {
                            customBlockUI();
        ...
        buttons: {
            confirm: {
                ...
                action: function () {
                    $.ajax({
                        type: "POST",
                        url: Base_url + "assessment/save_retake",
...
function save_question_remark() {
    $.ajax({
        url: Base_url + "assessment/save_question_remark",
        type: 'POST',
        data: $('#VideoPitchingForm').serializeArray(),
        beforeSend: function () {
            //customBlockUI();
...
function getparameter(Q_id, srno, q_cnt) {
    $.ajax({
        url: Base_url + "assessment/getquestionwiseparameter/" + Q_id + "/" + srno,
        type: 'POST',
        data: $('#VideoPitchingForm').serializeArray(),
        beforeSend: function () {
            customBlockUI();
...
function CandidateDatatableRefresh(assessment_id) {
    ...
    table.dataTable({
        ...
        "processing": true,
        "serverSide": true,
        "sAjaxSource": Base_url + "assessment/CandidateDatatableRefresh/" + assessment_id,
...
function AssessorDatatableRefresh(assessment_id) {
    ...
    oTable = table.dataTable({
        ...
        "processing": true,
        "serverSide": true,
        "sAjaxSource": Base_url + "assessment/AssessorDatatableRefresh/" + assessment_id,
        "fnServerData": function (sSource, aoData, fnCallback) {
            $.getJSON(sSource, aoData, function (json) {
                fnCallback(json);
            });
...
function AssessorSubDatatableRefresh(assessment_id, trainer_id) {
    ...
    oTable = table.dataTable({
        ...
        "processing": true,
        "serverSide": true,
        "sAjaxSource": Base_url + "assessment/AssessorSubDatatableRefresh/" + assessment_id + '/' + trainer_id,
        "fnServerData": function (sSource, aoData, fnCallback) {
            $.getJSON(sSource, aoData, function (json) {
                fnCallback(json);
            });
