function dashboard_refresh() {
    ...
    $.ajax({
        ...
        //async: false,
        url: base_url + "role_play_manager_dashboard/getdashboardData",
        beforeSend: function () {
            customBlockUI();
        },
...
function get_parameterdata(parameter_id, region_id, report_type, supervisor_id) {
    ...
    $.ajax({
        url: base_url + "role_play_manager_dashboard/parameter_scoredata",
        type: 'POST',
...
function get_regionwisedata(assessment_id, region_id, report_type) {
    ...
    $.ajax({
        url: base_url + "role_play_manager_dashboard/region_scoredata",
        type: 'POST',
...
function get_assessmentwisedata(assessment_id) {
    ...
    $.ajax({
        url: base_url + "role_play_manager_dashboard/assessment_parameter_scoredata",
        type: 'POST',
...
function get_regionlevel_graph(region_id) {
    $.ajax({
        url: base_url + "role_play_manager_dashboard/region_level_scoredata",
        type: 'POST',
...
function getDatewiseAssessment() {
    $.ajax({
        ...
        //async: false,
        url: base_url + "role_play_manager_dashboard/getDatewiseAssessment",
        beforeSend: function () {
            customBlockUI();
        },
...
function getDatewiseRegion() {
    $.ajax({
        ...
        data: {StartDate: StartDate, EndDate: EndDate},
        //async: false,
        url: base_url + "role_play_manager_dashboard/getDatewiseRegion",
        beforeSend: function () {
            customBlockUI();
        },
        success: function (msg) {
...
function dashboard_region_refresh() {
    $.ajax({
        ...
        url: base_url + "role_play_manager_dashboard/getFilterDashboardData",
        beforeSend: function () {
            customBlockUI();
        },
        success: function (data) {
...
function dashboard_region_change(move_val) {
    ...
    $.ajax({
        ...
        //async: false,
        url: base_url + "role_play_manager_dashboard/getRegionChart",
...
function SubmitData() {
    $.ajax({
        url: base_url + "role_play_manager_dashboard/update_range",
        type: 'POST',
...
function getWeek(){
    $.ajax({
        ...
        async: false,
        url: base_url +"role_play_manager_dashboard/ajax_getWeeks",
        beforeSend: function () {
            customBlockUI();
        },
        success: function (msg) {                        
...
function assessment_index_refresh(){
    ...
    $.ajax({
        ...
        //async: false,
        url: base_url +"role_play_manager_dashboard/load_assessment_index",
        beforeSend: function () {
            customBlockUI();
        },
...
function parameter_index_refresh(){
    $.ajax({
        type: "POST",
         data: {report_by: $('#report_by').val(), report_type: $('#report_type').val(),rpt_period:$('#rpt_period').val(),parameter_id:$('#parameter_id').val(),
             month:$('#month').val(),year:$('#year').val(),week:$('#week').val(),StartDate: StartDate, EndDate: EndDate, user_id: $('#user_id').val()},
        //async: false,
        url: base_url +"role_play_manager_dashboard/load_parameter_index",
        beforeSend: function () {
            customBlockUI();
        },
        success: function (response) {
...
function load_questions(company_id,assessment_id,user_id){
    ...
    $.ajax({
        ...
        processData: false,
        type       : 'POST',
        url        : base_url+"/role_play_manager_dashboard/fetch_questions/",
        data       : form_data,
        beforeSend: function () {
            customBlockUI();
        },
